...
* Writes [tests](https://docs.gitlab.com/ee/development/testing_guide/best_practices/) with every MR and works to uplift the quality of the code.
...
* Adopts a security minded software development approach by following [Secure Coding Guidelines](https://docs.gitlab.com/ee/development/secure_coding_guidelines/) early in the development process.
