...
- **Product knowledge:** Have working knowledge of your [group][product-hierarchy].
...
- **Product knowledge:** Deeply understand the technology and features of your [group][product-hierarchy] and proactively learn about other groups.
...
- **Communication:** Communicate UX activities with a strong point of view that highlights iteration and collaboration for user outcomes.
...
- **Design system:** Actively contribute to the [Pajamas Design System][pajamas], help determine whether components are single-use or multi-use, and provide recommendations to other designers regarding new component requests.
...
- **Deferred UX:** Minimize [deferred UX][deferred-ux] in your group with [MVCs](/handbook/product/product-principles/#the-minimal-viable-change-mvc), and help identify, prioritize, and fix when it occurs.
...
- **Product knowledge:** Deeply understand the technology and features of your [group][product-hierarchy] and have a working knowledge of the end-to-end GitLab product.
...
- **Product knowledge:** Deeply understand the technology and features within your [stage][product-hierarchy] and have knowledge of the end-to-end GitLab product.
...
In addition to embedding in [groups][product-hierarchy] that focus on a specific product area, we also have a Foundations team that works on building a cohesive and consistent user experience across platform experiences like navigation, both visually and functionally. You’ll be responsible for leading the direction of the experience design, visual style, and technical tooling of the GitLab product. You’ll act as a centralized resource, helping to triage large-scale experience problems as the need arises.
