...
|--------------------------|--------------------|-------------------|
| Interlock candidate      | {{< label name="Interlock candidate" color="#854bbe" light="true" >}} | Identifies epics as part of the R&D Interlock process; automatically applied through the epic template |
...
| Stage                    | {{< label name="devops::plan" color="#e44d2a" light="true" >}} <br> {{< label name="devops::create" color="#e44d2a" light="true" >}} <br> {{< label name="devops::verify" color="#e44d2a" light="true" >}} <br> *more labels available in series....*| Specifies which product stage is responsible for the work; enables stage leaders to view all commitments for their area |
...
| Interlock priority     |  {{< label name="Interlock Priority::E1" color="#cd5b45" light="true" >}} <br> {{< label name="Interlock Priority::E2" color="#cd5b45" light="true" >}} <br> {{< label name="Interlock Priority::E3" color="#cd5b45" light="true" >}} <br> {{< label name="Interlock Priority::P1" color="#cc338b" light="true" >}} <br> {{< label name="Interlock Priority::P2" color="#cc338b" light="true" >}}  <br> {{< label name="Interlock Priority::P3" color="#cc338b" light="true" >}} | Interlock Priority labels indicate the level of confidence and commitment for both Product-driven (P1/P2/P3) and Engineering-driven (E1/E2/E3) initiatives. <br><br> - P1/E1 indicates 100% confidence in delivery with full resource commitment. <br> - P2/E2 indicates 80% confidence in delivery. <br>- P3/E3 indicates 50% confidence and may be deprioritized if P1/P2 or E1/E2 items are at risk. <br><br> Product priority (P) labels are used for customer-facing features, while Engineering priority (E) labels are used for technical improvements with internal visibility only. |
| Go-to-market tier        | {{< label name="GTM tier::Tier 1" color="#067aef" light="true" >}} <br> {{< label name="GTM tier::Tier 2" color="#067aef" light="true" >}}  <br> {{< label name="GTM tier::Tier 3" color="#067aef" light="true" >}}  | GTM tier labels apply to a subset of Product-driven initiatives that will be communicated externally to customers and stakeholders. They represent Go-To-Market priority and visibility: <br><br> - Tier 1: Highest confidence, externally communicated commitments  <br> - Tier 2: High confidence items communicated to customers <br> - Tier 3: Directional items that may be communicated externally <br><br> GTM tiers are suggested during the collaboration phase, then finalized during the GTM Alignment Discussion (Week 10) with input from Marketing and Sales leadership. GTM priority tiers can never be higher than their corresponding Product priority (P1-P3) to avoid priority inversion. |
| Investment theme         | {{< label name="Investment theme::AI across SDLC" color="#1b694f" light="true" >}} <br> {{< label name="Investment theme::Core DevOps" color="#1b694f" light="true" >}}  <br> {{< label name="Investment theme::Security & Compliance" color="#1b694f" light="true" >}}                    | Connects work to company's strategic investment areas as outlined in the FY26 company strategy; enables filtering to track progress on key company initiatives |
| Subscription tier        | {{< label name="GitLab Free" color="#8e44ad" light="true" >}} <br> {{< label name="GitLab Premium" color="#8e44ad" light="true" >}} <br> {{< label name="GitLab Ultimate" color="#8e44ad" light="true" >}}                                                                                | Specifies which GitLab subscription tier(s) will include the feature; helps with planning go-to-market activities |
...
| Quarters                 | {{< label name="FY27::Q1" color="#cc338b" light="true" >}} <br> {{< label name="FY27::Q2" color="#cc338b" light="true" >}} <br> {{< label name="FY27::Q3" color="#cc338b" light="true" >}} <br> *more labels available in series....*                                                     | Indicates the target delivery quarter for planning and tracking purposes; critical for filtering by timeframe |
| Interlock status labels  | {{< label name="Interlock status::New/Proposal in progress" color="#d77092" light="true" >}} <br> {{< label name="Interlock status::Alternate proposed" color="#d77092" light="true" >}} <br> {{< label name="Interlock status::Ready for review" color="#d77092" light="true" >}} <br> {{< label name="Interlock status::GPM/Director approved" color="#d77092" light="true" >}} <br> {{< label name="Interlock status::VP approved" color="#d77092" light="true" >}} <br> {{< label name="Interlock status::Changed requested" color="#dc143c" light="true" >}} <br> {{< label name="Interlock status::Canceled" color="#d77092" light="true" >}} <br> {{< label name="R&D roadmap status::Executing" color="#c21e56" light="true" >}} <br> {{< label name="R&D roadmap status::Completed" color="#c21e56" light="true" >}} | Tracks the current state of the epic in the interlock process; updated as the epic progresses through review stages; drives board views and reporting |
| Interlock changed       | {{< label name="Interlock changed" color="#808080" light="true" >}} | Identifies epics where the committed quarter was changed as part of the R&D Interlock process |
...
| Health                   | {{< label name="health::on track" color="#009966" light="true" >}} <br> {{< label name="health::needs attention" color="#ed9121" light="true" >}} <br> {{< label name="health::at risk" color="#dc143c" light="true" >}}                                                                  | Indicates the delivery risk during execution phase; updated weekly by EMs once the quarter begins; helps leadership identify items requiring intervention <br><br> *(Note: we are using labels for health status until epic boards can utilize the [health status](https://docs.gitlab.com/user/group/epics/manage_epics/#health-status) feature)* |
