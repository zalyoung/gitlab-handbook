...
We have [Merge Request Coaches](/job-families/expert/merge-request-coach/) who help contributors get their merge requests to meet the [contribution acceptance criteria](https://docs.gitlab.com/development/contributing/merge_request_workflow/#contribution-acceptance-criteria),
...
Customers are afraid of confusing or unsanctioned licenses entering a business environment. -
 We don't use a limiting license such as SSPL. As we highlight [in our docs](https://docs.gitlab.com/development/licensing/),
...
1. Does it meet the [contribution acceptance criteria](https://docs.gitlab.com/development/contributing/merge_request_workflow/#contribution-acceptance-criteria)?
...
and it has met the [contribution acceptance criteria](https://docs.gitlab.com/development/contributing/merge_request_workflow/#contribution-acceptance-criteria),
