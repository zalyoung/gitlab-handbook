...
1. SLSA level 3 attestations are generated by default (currently we generate [SLSA level 1 attestations](https://docs.gitlab.com/ci/runners/configure_runners/#artifact-attestation) by default)
...
1. Added dcouemntation on how to [Use Sigstore for keyless signing and verification](https://docs.gitlab.com/ci/yaml/signing_examples/)
