...
1. **Collaboration Cadence:** In an office environment, design teams organically build and fall into a cadence of meetings, collaboration, and other team-based activities. When these in-person exchanges are not available, it's important design teams establish [asynchronous workflows](../asynchronous/) and learn how to [collaborate through text]({{< ref "../collaboration-and-whiteboarding#collaborating-through-text" >}}).
