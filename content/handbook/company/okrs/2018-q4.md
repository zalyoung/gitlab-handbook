...
- VPE: Make GitLab.com ready for mission critical customer workloads => 70%, meeting our business goals but by no means perfect, lots of automation to do.
  ...
  - Dev Backend:
    - Adopt in collaboration with Product a consistent process for prioritizing
      ...
      help close gap.
    - Perform 3 iterations on [retrospective](/handbook/engineering/management/group-retrospectives/) process to be more effective for Engineering (3/3) => 80%
    - Gitaly:
  ...
  - Ops Backend:
    ...
    - [Philippe Lafoucrière](/handbook/company/team/#plafoucriere):
      - Benchmark 3 new security tools for integration in the [Security Products](/handbook/engineering/development/sec/secure/#security-products): No security tool was benchmarked (0%)
