...
[Boards](https://docs.gitlab.com/ee/user/project/issue_board/) in GitLab make it possible to visualize and manage lists of issues which can be defined by one of three ways: **Labels**, **Team members**, and **Milestones**.
