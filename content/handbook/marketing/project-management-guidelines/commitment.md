...
Using an [issue template](https://docs.gitlab.com/user/project/description_templates/) helps to consistently define the process and make it easy to get started.
