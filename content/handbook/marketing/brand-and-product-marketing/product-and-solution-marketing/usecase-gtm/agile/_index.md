...
| --------------------------------------------------- | :-------: | :-------: | :-------: | :-------: | :------- |
| Plan and track work with [Issues](https://docs.gitlab.com/user/project/issues/) | X | X | X | `redis_hll_counters.issues_edit.issues_edit_total_unique_counts_monthly` | Tracks unique monthly active users that take one or more action on an Issue |
| Manage complex workstreams across Groups and Projects with [Epics](https://docs.gitlab.com/user/group/epics/) | | X | X | `redis_hll_counters.epics_usage.epics_usage_total_unique_counts_monthly` | Tracks unique monthly active users that create one or more Epics |
...
| Use Groups and Subgroups to model their organization's Value Streams | X | X | X | [`usage_activity_by_stage.manage.groups`](https://docs.gitlab.com/development/stage_group_observability/) | Tracks unique monthly active users creating Groups |
