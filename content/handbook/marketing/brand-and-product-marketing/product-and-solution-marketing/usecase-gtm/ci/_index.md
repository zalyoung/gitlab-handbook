...
| ------ | ------ | ------ | ------ | ----
| Build automation | Architect CI pipelines with .gitlab-ci.yml files, structure CI processes, and build your app using GitLab Runner as the execution agent. Includes [CI services](https://docs.gitlab.com/ci/services/), [parent-child pipelines](https://docs.gitlab.com/ci/pipelines/downstream_pipelines/#parent-child-pipelines), [multi-project pipelines](https://docs.gitlab.com/ci/pipelines/downstream_pipelines/#multi-project-pipelines), and [merge trains](https://docs.gitlab.com/ci/pipelines/merge_trains/) | [**Verify stage:**](https://about.gitlab.com/stages-devops-lifecycle/verify/) [CI](https://docs.gitlab.com/ci/), [GitLab Runner](https://docs.gitlab.com/runner/), [Merge Trains](https://docs.gitlab.com/ci/pipelines/merge_trains/) | [![Build automation](/images/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/ci/youtube_social_icon_red-32x23.png) Build and test automation](https://youtu.be/rti7T1yGrlw) |
| Test automation | Run various automated tests in your CI pipelines to verify/validate code pre-production. Includes Unit tests, integration testing, browser performance testing, code quality, code coverage, usability testing, and accessibility testing.  | [**Verify stage:**](https://about.gitlab.com/stages-devops-lifecycle/verify/) [CI](https://docs.gitlab.com/ci/), [Code Quality](https://docs.gitlab.com/ci/testing/code_quality/), [Code Testing and Coverage](https://docs.gitlab.com/ci/testing/unit_test_reports/), [Web Performance](https://docs.gitlab.com/ci/testing/browser_performance_testing/), [Usability Testing](https://docs.gitlab.com/ci/review_apps/#visual-reviews), [Accessibility Testing](https://docs.gitlab.com/ci/testing/accessibility_testing/)| [![Test automation](/images/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/ci/youtube_social_icon_red-32x23.png) Build and test automation](https://youtu.be/rti7T1yGrlw) |
| Pipeline configuration management | [AutoDevOps](https://docs.gitlab.com/topics/autodevops/) automatically sets your CI/CD configuration based on pre-configured CI/CD templates. | [**Verify stage**](https://about.gitlab.com/stages-devops-lifecycle/verify/) <br> [**Package stage**](https://about.gitlab.com/stages-devops-lifecycle/package/) <br> [**Secure stage**](https://about.gitlab.com/stages-devops-lifecycle/secure/) <br> [**Release stage**](https://about.gitlab.com/stages-devops-lifecycle/release/) <br> [**Configure stage**](https://about.gitlab.com/stages-devops-lifecycle/configure/) <br> [**Monitor stage**](https://about.gitlab.com/stages-devops-lifecycle/monitor/) | [![Pipeline configuration management](/images/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/ci/youtube_social_icon_red-32x23.png) Pipeline configuration management](https://youtu.be/opdLqwz6tcE) |
| Visibility and collaboration | See code quality analysis and code coverage details from source code. Get feedback on code changes directly in GitLab with [merge requests (MRs)](https://docs.gitlab.com/user/project/merge_requests/) and [issues](https://docs.gitlab.com/user/project/issues/): edit, comment, review, and share in one place. Preview changes in review apps, see commit history, and get automatic alerts on important events. | [**Verify stage:**](https://about.gitlab.com/stages-devops-lifecycle/verify/) [CI](https://docs.gitlab.com/ci/), [Code Quality](https://docs.gitlab.com/ci/testing/code_quality/), [Code Testing and Coverage](https://docs.gitlab.com/ci/testing/unit_test_reports/) <br> [**Create stage:**](https://about.gitlab.com/stages-devops-lifecycle/create/) [Code Review](https://about.gitlab.com/stages-devops-lifecycle/create/), [Source Code Management](https://about.gitlab.com/solutions/source-code-management/), [Design Management](https://docs.gitlab.com/user/project/issues/design_management/) <br> [**Configure stage:**](https://about.gitlab.com/stages-devops-lifecycle/configure/) [ChatOps](https://docs.gitlab.com/ci/chatops/) <br> [**Release stage:**](https://about.gitlab.com/stages-devops-lifecycle/release/) [Review Apps](https://docs.gitlab.com/ci/review_apps/) | [![Visibility and collaboration](/images/marketing/brand-and-product-marketing/product-and-solution-marketing/usecase-gtm/ci/youtube_social_icon_red-32x23.png) Visibility and collaboration](https://youtu.be/z8r3rFQT8xg) |
...
| ------------------------------------------------------------ | -----| ---- | ---- | --------- | ---- |
| [Try Auto DevOps](https://docs.gitlab.com/topics/autodevops/#quick-start)  |   x    |   x   |  x    |     instance_auto_devops_enabled and counts.ci_pipeline_config_auto_devops       |    |
| [Enable shared runners](https://docs.gitlab.com/ci/runners/)  |   x    |   x   |   x   |   gitlab_shared_runners_enabled        ||
| Enable [container registry](https://docs.gitlab.com/administration/packages/container_registry/#enable-the-container-registry) across instance  |   x    |  x   |   x   |   container_registry_enabled        |   GitLab.com container registry enabled at [Group level](https://docs.gitlab.com/user/packages/container_registry/#control-container-registry-for-your-group)  |
| Build [Instance Template Repository](https://docs.gitlab.com/administration/settings/instance_template_repository/)  |       |   x    |  x     |     counts.template_repositories      |     |
| Create [custom instance-level project templates](https://docs.gitlab.com/administration/custom_project_templates/) |       |   x   |  x    | counts.ci_pipeline_config_repository   |GitLab.com can utilize [group-level project templates](https://docs.gitlab.com/user/group/custom_project_templates/)  |
...
| [Convert declarative Jenkinsfiles](https://docs.gitlab.com/ci/migration/jenkins/) *(Jenkins conversion only)* |    x   |   x   |  x    |     counts.projects_jenkins_active      |     |
| **Run your pipeline!** CI/CD examples can be [viewed here](https://docs.gitlab.com/ci/examples/)  |   x    |  x    |  x    |     usage_activity_by_stage.verify.ci_pipelines       |    |
| Make use of GitLab's [CI feature index](https://docs.gitlab.com/ci/#gitlab-cicd-features)   |   x    |   x   |   x   |      counts.ci_runners, counts.ci_builds     |     |
|[Trigger Deployments](https://docs.gitlab.com/ci/environments/)    |   x    |   x   |   x   |  usage_activity_by_stage_monthly.release.deployments         |     |
| [Use Compliance Framework](https://docs.gitlab.com/user/project/settings/#compliance-frameworks) | | x | x | usage_activity_by_stage.manage.projects_with_compliance_framework | |
|[View Audit Events](https://docs.gitlab.com/administration/audit_event_reports/)    |      |   x   |   x   |  compliance_unique_visits.g_compliance_audit_events         |     |
| [View Value Stream Analytics](https://docs.gitlab.com/user/group/value_stream_analytics/) | x | x | x | analytics_unique_visits.p_analytics_valuestream| |
| [View DevOps Adoption](https://docs.gitlab.com/user/group/devops_adoption/) | | | x | analytics_unique_visits.i_analytics_dev_ops_adoption| |
| [Migrate projects to GitLab](https://docs.gitlab.com/user/project/import/) | x | x | x | usage_activity_by_stage.manage.project_imports.total | |
| [Authenticate with external providers](https://docs.gitlab.com/administration/auth/) | x | x | x| usage_activity_by_stage.manage.user_auth_by_provider.standard| |
...
- [Introduction to CI/CD with GitLab](https://docs.gitlab.com/ci/quick_start/)
- [Getting started with GitLab CI/CD](https://docs.gitlab.com/ci/quick_start/)
- [GitLab CI/CD Examples](https://docs.gitlab.com/ci/examples/)
- [Migrating From CircleCI to GitLab](https://docs.gitlab.com/ci/migration/circleci/)
- [Migrating from Jenkins to GitLab](https://docs.gitlab.com/ci/migration/jenkins/#migrating-from-jenkins)
...
- Reliability and compliance: get the ability to [audit logs](https://docs.gitlab.com/administration/audit_event_reports/), [auditor users](https://docs.gitlab.com/administration/auditor_users/), and have an actionable [disaster recovery strategy](https://docs.gitlab.com/administration/geo/disaster_recovery/) with support for [High Availability](https://docs.gitlab.com/administration/reference_architectures/).

**Key features with Premium:**

- [Multi Project Pipelines](https://docs.gitlab.com/ci/pipelines/downstream_pipelines/#multi-project-pipelines)- link CI pipelines from multiple projects.
- [Operations dashboard](https://docs.gitlab.com/user/operations_dashboard/#doc-nav)- get a holistic view of the overall health of CI/CD pipelines and organization wide operations.
- [Browser Performance Testing](https://docs.gitlab.com/ci/testing/browser_performance_testing/)- detect performance regressions within your applications.
- [CI/CD for external repositories](https://docs.gitlab.com/ci/ci_cd_for_external_repos/)- connect your external repositories instead of moving your entire existing project(s) to get the benefits of GitLab CI/CD. This feature supports [GitHub](https://docs.gitlab.com/ci/ci_cd_for_external_repos/github_integration/), [Bitbucket Cloud](https://docs.gitlab.com/ci/ci_cd_for_external_repos/bitbucket_integration/), and any other Git-based repository.
...
- [Static Application Security Testing](https://docs.gitlab.com/user/application_security/sast/)- check for potential security issues by evaluating static code.
- [Dynamic Application Security Testing](https://docs.gitlab.com/user/application_security/dast/)- analyze review applications to identify potential security issues.
- [Dependency Scanning](https://docs.gitlab.com/user/application_security/dependency_scanning/)- evaluate third-party dependencies to identify potential security issues.
- [Container Scanning](https://docs.gitlab.com/user/application_security/container_scanning/)- analyze Docker images and check for potential security issues.
- [Security Dashboard](https://docs.gitlab.com/user/application_security/security_dashboard/#project-security-dashboard)- visualize security status for projects.
