...
| Enable [container registry](https://docs.gitlab.com/ee/administration/packages/container_registry/#enable-the-container-registry) across instance  |   x    |  x   |   x   |   container_registry_enabled        |   GitLab.com container registry enabled at [Group level](https://docs.gitlab.com/ee/user/packages/container_registry/#control-container-registry-for-your-group)  |
| Build [Instance Template Repository](https://docs.gitlab.com/ee/administration/settings/instance_template_repository/)  |       |   x    |  x     |     counts.template_repositories      |     |
| Create [custom instance-level project templates](https://docs.gitlab.com/ee/administration/custom_project_templates/) |       |   x   |  x    | counts.ci_pipeline_config_repository   |GitLab.com can utilize [group-level project templates](https://docs.gitlab.com/ee/user/group/custom_project_templates/)  |
...
| [Convert declarative Jenkinsfiles](https://docs.gitlab.com/ee/ci/migration/jenkins/) *(Jenkins conversion only)* |    x   |   x   |  x    |     counts.projects_jenkins_active      |     |
...
|[View Audit Events](https://docs.gitlab.com/ee/administration/audit_event_reports/)    |      |   x   |   x   |  compliance_unique_visits.g_compliance_audit_events         |     |
...
- [Migrating From CircleCI to GitLab](https://docs.gitlab.com/ee/ci/migration/circleci/)
- [Migrating from Jenkins to GitLab](https://docs.gitlab.com/ee/ci/migration/jenkins/#migrating-from-jenkins)
...
- Reliability and compliance: get the ability to [audit logs](https://docs.gitlab.com/ee/administration/audit_event_reports/), [auditor users](https://docs.gitlab.com/ee/administration/auditor_users/), and have an actionable [disaster recovery strategy](https://docs.gitlab.com/ee/administration/geo/disaster_recovery/) with support for [High Availability](https://docs.gitlab.com/ee/administration/reference_architectures/).

**Key features with Premium:**

- [Multi Project Pipelines](https://docs.gitlab.com/ee/ci/pipelines/downstream_pipelines/#multi-project-pipelines)- link CI pipelines from multiple projects.
- [Operations dashboard](https://docs.gitlab.com/ee/user/operations_dashboard/#doc-nav)- get a holistic view of the overall health of CI/CD pipelines and organization wide operations.
- [Browser Performance Testing](https://docs.gitlab.com/ee/ci/testing/browser_performance_testing/)- detect performance regressions within your applications.
- [CI/CD for external repositories](https://docs.gitlab.com/ee/ci/ci_cd_for_external_repos/)- connect your external repositories instead of moving your entire existing project(s) to get the benefits of GitLab CI/CD. This feature supports [GitHub](https://docs.gitlab.com/ee/ci/ci_cd_for_external_repos/github_integration/), [Bitbucket Cloud](https://docs.gitlab.com/ee/ci/ci_cd_for_external_repos/bitbucket_integration/), and any other Git-based repository.
