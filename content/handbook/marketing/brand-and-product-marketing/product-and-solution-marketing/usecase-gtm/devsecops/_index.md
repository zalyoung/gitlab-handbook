...
- [Security Approvals in Merge Requests](https://docs.gitlab.com/ee/user/project/merge_requests/approvals/settings/#security-approvals-in-merge-requests)
...
One of the first partners to [integrate their scan results](https://docs.gitlab.com/ee/development/integrations/secure/) into the GitLab Security Dashboard and the GitLab CI pipeline is [WhiteSource](https://www.mend.io/).
...
- [How to capitalize on GitLab Security tools with external CI](https://docs.gitlab.com/ee/integration/jenkins/)
