...
| [Setup and use feature flags](https://docs.gitlab.com/ee/operations/feature_flags/) | x | x | x | | |
...
- Deployment Strategies: support for [canary deployments](https://docs.gitlab.com/ee/user/project/canary_deployments/), [incremental roll outs](https://docs.gitlab.com/ee/ci/environments/incremental_rollouts/), [blue green deployments](https://docs.gitlab.com/ee/ci/environments/incremental_rollouts/#blue-green-deployment) and feature flags to give you confidence in your releases
- [Deploy boards](https://docs.gitlab.com/ee/user/project/deploy_boards/): gives a consolidated view of health and status of Kubernetes deployments
...
- [Release Evidence](https://docs.gitlab.com/ee/user/project/releases/#release-evidence): snapshot of releases data to compare and audit releases
- [Vault integrations](https://docs.gitlab.com/ee/ci/secrets/hashicorp_vault/): authentication of secrets via Hashicorp Vault
...
- [Environments dashboard](https://docs.gitlab.com/ee/ci/environments/environments_dashboard/) - cross project environment based view to track deployment status
