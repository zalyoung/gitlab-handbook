...
| [Setup GitLab CI](https://docs.gitlab.com/ci/quick_start/) | x | x | x |  | Having a .gitlab-ci.yml is the basis of using GitLab for deployment |
| [Setup an Environment](https://docs.gitlab.com/ci/environments/) | x | x | x | counts.environmnets | |
| [Deploy to an Environment](https://docs.gitlab.com/ci/environments/#view-environments-and-deployments) | x | x | x | counts.deployments, usage_activity_by_stage_monthly.release.deployments | |
| [Create a Release](https://docs.gitlab.com/user/project/releases/) | x | x | x | counts.releases | |
| [Create Release Evidence](https://docs.gitlab.com/user/project/releases/#release-evidence) | x | x | x | | |
| [Setup and use feature flags](https://docs.gitlab.com/operations/feature_flags/) | x | x | x | | |
...
- [Package repository](https://docs.gitlab.com/user/packages/): private repository for a variety of package managers
- Deployment Strategies: support for [canary deployments](https://docs.gitlab.com/user/project/canary_deployments/), [incremental roll outs](https://docs.gitlab.com/ci/environments/incremental_rollouts/), [blue green deployments](https://docs.gitlab.com/ci/environments/incremental_rollouts/#blue-green-deployment) and feature flags to give you confidence in your releases
- [Deploy boards](https://docs.gitlab.com/user/project/deploy_boards/): gives a consolidated view of health and status of Kubernetes deployments
- [Multiple Kubernetes Clusters](https://docs.gitlab.com/user/group/clusters/#multiple-kubernetes-clusters): allows you to maintain different clusters for different environments such as for test, staging and production
- [Environments and Deployments](https://docs.gitlab.com/user/group/clusters/#multiple-kubernetes-clusters): configure multiple environments, manage and monitor them from GitLab
- [GitLab Pages](https://docs.gitlab.com/user/project/pages/): deploy static web pages directly from GitLab
- [Deploy Tokens](https://docs.gitlab.com/user/project/deploy_tokens/): secure your package and container registry images by requiring username/password for access
- [Release Evidence](https://docs.gitlab.com/user/project/releases/#release-evidence): snapshot of releases data to compare and audit releases
- [Vault integrations](https://docs.gitlab.com/ci/secrets/hashicorp_vault/): authentication of secrets via Hashicorp Vault
- [ChatOps](https://docs.gitlab.com/ci/chatops/): interact with GitLab via chat services
- [AutoDevOps](https://docs.gitlab.com/topics/autodevops/): simplify build, test, deploy, monitor of your applications
...
- [Dependency Proxy](https://docs.gitlab.com/user/packages/dependency_proxy/) - local proxy for packages
...
- [Environments dashboard](https://docs.gitlab.com/ci/environments/environments_dashboard/) - cross project environment based view to track deployment status
...
- [Compliance dashboard](https://docs.gitlab.com/user/compliance/compliance_center/) - high level view of project compliance status and merge request approvers
...
- [Dynamic Application Security Testing](https://docs.gitlab.com/user/application_security/dast/)- analyze review applications to identify potential security issues on running web applications before deployment
