...
When working on the GitLab product, it's important to follow the established [contribution guidelines](https://docs.gitlab.com/development/contributing/) and [code review process](https://docs.gitlab.com/development/code_review/). This includes:

1. [Writing clear commit messages](https://docs.gitlab.com/development/contributing/merge_request_workflow/#commit-messages-guidelines)
2. Opening a merge request with a detailed description
3. Addressing any feedback from [reviewers](https://docs.gitlab.com/development/code_review/#reviewer-roulette)

Additionally, make sure to:

- [Write and update tests](https://docs.gitlab.com/development/code_review/#quality) as necessary
- Follow GitLab's [coding standards](https://docs.gitlab.com/development/contributing/style_guides/)
