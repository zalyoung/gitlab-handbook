...
- Create a GitLab account and [set up SSH keys](https://docs.gitlab.com/ee/user/ssh/).
...
- [Read GitLab's contribution guidelines](https://docs.gitlab.com/ee/development/contributing/) with a special focus on the [Merge Request Workflow](https://docs.gitlab.com/ee/development/contributing/merge_request_workflow/)
