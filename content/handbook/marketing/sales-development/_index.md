...
A career mobility issue should be opened 2 weeks before the transition date by the people connect team. If the aligned manager does not see that issue created 2 days before the scheduled transition date, the manager should reach out to the People Connect Team via the [#people-operations Slack Channel](https://gitlab.slack.com/archives/C02360SQQFR).
...
- The people team will create an [offboarding issue](/handbook/people-group/offboarding/#offboarding), complete all 'Manager' tasks on the issue. If you have any questions use the #managers #people-operations slack channels. You can also reach out to the assigned people ops team member on the issue.
