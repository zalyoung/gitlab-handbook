...
Teams can utilize [Adobe's QR Code Generator](https://www.adobe.com/express/feature/image/qr-code-generator) to create specific QR Codes. We  promote different pieces of collateral passed out at the booth and signage we have created promoting registration for an on-site ancillary or virtual event. Other use cases such as people scanning to attend onsite virtual activities such as coding challenges or UX surveys.

#### Login for the QR Code Generator

You can login through your Adobe account (if you are provisioned Marketo), or create one.
