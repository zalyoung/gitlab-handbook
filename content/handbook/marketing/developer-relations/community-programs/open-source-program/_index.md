...
To request an exception, [create an issue in the GitLab for Open Source Program project](https://gitlab.com/gitlab-com/marketing/developer-relations/open-source-program/gitlab-for-open-source/-/issues/new?issuable_template=program-qualification-exception-request) using the `program-qualification-exception-request` template.
...
Depending on where an open source project is hosted (on the SaaS or a Self-managed instance), the form requests different information from an applicant.
...
The GitLab Open Source Partners Program project contains sensitive data and personally identifying information about program members.
...
The GitLab Open Source Partners program is a commuinity-focused marketing effort designed to highlight ways high-profile open source communities are using—and succeeding with—GitLab.
