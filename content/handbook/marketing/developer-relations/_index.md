...
**OKR Health:** We use [issue health](https://docs.gitlab.com/user/project/issues/managing_issues/#health-status) indicators to help people understand an OKRs status at a glance. These status indicators are:
