...
- Maintain a [templates project for the DevRel group](https://gitlab.com/everyonecancontribute/devrel/gitlab-templates), which [provides issue/MR templates in a single source of truth](https://docs.gitlab.com/user/project/description_templates/#set-group-level-description-templates).
