...
- All non-Sales users: Access to Jifflenow is managed through Lumos. If you do not have the Jifflenow tile in Okta, please request access to JiffleNow via Lumos in OKTA. You will need access through Okta to request meetings if you are not a sales user.
