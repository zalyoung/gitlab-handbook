...
Specifically, for a Marketing related role (SDRs/BDRs) please open an [individual access request - AR for short](/handbook/security/corporate/it/end-user-services/onboarding-access-requests/access-requests/) and tag your manager for approval and `RobRosu` (Mops), while for a Field Sales related role (AEs/SAEs/ASMs/ISRs) open an AR and tag your manager for approval and `@kbetances` (Sales Operations).
