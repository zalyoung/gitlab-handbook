...
- All purchases/services with a total contract value over $5000 are **required** to have a purchase order, unless it falls under the [PO Exception Policy](https://handbook.gitlab.com/handbook/finance/procurement/#what-are-the-exceptions-to-the-po-policy). One-time or purchases totaling <$5000 annually may be processed without a PO per the PO Exception Policy
