...
1. *CES*: Issue a [Job Change Letter](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#job-change-letter) to finalize the beginning of the interim period. The Letter should include: interim job title, start date, and end date (if known). Job Change letters are important as this is the process by which Total Rewards is notified of change from Greenhouse.
