...
- The use of high risk remote administration tools (e.g. TeamViewer, AnyDesk, Chrome Remote Desktop) which are [commonly used by attackers](https://attack.mitre.org/techniques/T1219/) to gain and remotely control systems.
