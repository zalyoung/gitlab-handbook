...
For new employees who have not received a company laptop, there are [exception processes](/handbook/security/corporate/end-user-services/onboarding-access-requests/#exception-processes) for using non-company devices.
