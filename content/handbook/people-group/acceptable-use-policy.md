...
For new employees who have not received a company laptop, there are [exception processes](/handbook/security/corporate/end-user-services/laptop-management/laptop-ordering/#exception-processess) for using non-company devices.
