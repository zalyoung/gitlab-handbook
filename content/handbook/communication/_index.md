...
| What/When|The GitLab Handbook | The Loop (coming soon) | Slack | Email/Newsletters | Meetings |
| ---------- | ---------- | ----------- | ----------- | -----------| -----------|
...
1. Optional AMA.
   If desired and appropriate, offer a company wide Zoom call to host an AMA (Ask Me Anything). Oftentimes, questions can be managed within the Discussion tab of a GitLab Issue or Merge Request. For broad announcements, such as registration opening for GitLab Contribute, an AMA may be better suited for a large volume of inquiries. To schedule a company wide call, please make a request in the `#people-operations` Slack channel, and include a Google Doc in the invite for questions.
