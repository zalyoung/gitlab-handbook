...
The [global search team](https://gitlab.slack.com/archives/C3TMLK465) maintains a [page](https://docs.gitlab.com/ee/integration/advanced_search/elasticsearch/) on the basic "know-hows" of setting up Elasticsearch and integrating with GitLab.
...
- [Advanced Search Syntax](https://docs.gitlab.com/ee/user/search/advanced_search/)
