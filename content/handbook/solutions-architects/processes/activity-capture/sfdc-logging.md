...
- Available options include:
  ...
  - **Win**: A technical win should closely relate to the opportunity win and is depended on factors such as identifying decision maker, critical business issue, problems(MEDDPIC), can our solution deliver specific caibilities by the critical dates listed along with quantifiable value.
