...
- Getting GitLab Duo trial Licenses
  - For existing GitLab customers, [follow the steps here to request Duo trail](https://docs.gitlab.com/subscriptions/subscription-add-ons/#start-gitlab-duo-pro-trial)
