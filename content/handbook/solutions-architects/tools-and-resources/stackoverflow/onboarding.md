...
### SMB Team Members
When joining the SMB Team, the current process is to have the SMB [Community Manager](https://handbook.gitlab.com/handbook/solutions-architects/tools-and-resources/stackoverflow/administration/#community-managers) add the new team member(s) directly to the [Stack Overflow Google group](https://groups.google.com/a/gitlab.com/g/okta-stackoverflow-users) as a "Member".  Adding a name to that group will allow the SMB team members to access the Stack Overflow Okta tile. 


## Offboarding

When a team member is being Offboarded, access to their Okta groups will be will revoked as part of the regular GitLab [Offboarding](https://handbook.gitlab.com/handbook/people-group/engineering/offboarding/) process. However, due to the nature of the way it's currently set up, the user will need to be manually deactivated within Stack Overflow. 
