...
1. **Work according to GitLab's values.** Our shared work values are a gift. They help increase trust and align expectations in how we work and what we can expect from each other. If you ever feel that I'm working in a way that is conducive with GitLab values, let me know, so I can learn from your observation.
