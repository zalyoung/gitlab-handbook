...
| [GS] Geo? | Is your customer using Geo? Manually filled by the CSM |  | [Link](https://docs.gitlab.com/administration/geo/) |
| [GS] GitLab Issue Link | Account related GitLab Issue(s) |  |  |
| [GS] Google Doc Notes | Google Doc Notes URL Manually filled by the CSM |  |  |
| [GS] High Availability? | Does your customer require High Availability (HA) solutions and/or zero-downtime upgrade? Manually filled by the CSM |  | [Link](https://docs.gitlab.com/administration/reference_architectures/) |
