...
|---------------------------------------------|:-------------:|------------------------:|
| Field process for Risk Accounts (AMER)      |  @esivak      | n/a                     |
| Field process for Risk Accounts (EMEA)      |  @ofalk       | n/a                     |
| CSE campaigns                               |  @nesplin     | @afrusciano             |
| CI Product Coach                            |  @jconrad     | @ofalk                  |
| Security Product Coach                      |  @cguitarte   | @esivak                 |
| AI Product Coach                            |  tbd          | tbd                     |
| CSE Labs (collab with the Content Team)     |  tbd          | @ofalk ?                |
| CSE Webinars (collab with the Content Team) |  tbd          | @ofalk ?                |
| CSE Roles / Job family definitions          |  @ofalk       | @afrusciano             |
| CSE Onboarding                              |  tbd          | @esivak ?               |
| CSE Enablement                              |  tbd          | @ofalk ?                |
