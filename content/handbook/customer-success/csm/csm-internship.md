...
1. Learn about Git & GitLab
   ...
   1. [Start using Git on the command line](https://docs.gitlab.com/ee/topics/git/commands/)
...
1. Learn about Architecture/HA and what's best for each customer
   1. Learn about HA and our reference architectures
      ...
      1. Review [architecture overview documentation](https://docs.gitlab.com/ee/development/architecture/)
...
1. Review Geo and discuss with your mentor the different use cases and why customers should use it and when
   ...
   1. [Geo FAQ](https://docs.gitlab.com/ee/administration/geo/replication/faq/)
