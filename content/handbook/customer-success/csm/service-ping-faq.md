...
At this time, you can access the data through [a REST API connection](https://docs.gitlab.com/api/usage_data/#export-service-ping-data). We are starting to explore the possibilities to enable customer visualization and/or analysis.
...
1. [Admin Settings for Service Ping](https://docs.gitlab.com/administration/settings/usage_statistics/#service-ping)
1. [Usage Statistics Collected](https://docs.gitlab.com/administration/settings/usage_statistics/#usage-statistics-collected)
1. [Network Configuration](https://docs.gitlab.com/administration/settings/usage_statistics/#network-configuration)
1. [Accessing Service Ping through REST API](https://docs.gitlab.com/api/usage_data/#export-service-ping-data)
