...
| **Value Stream Management** | This customer-facing dashboard hosts [value stream analytics](https://docs.gitlab.com/user/group/value_stream_analytics/) metrics including DORA4 | GitLab customers | DORA 4 metricsm month-over-month usage metrics | |
