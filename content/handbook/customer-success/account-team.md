...
| Oversee a Proof of Value | Timeboxed mutually agreed upon evaluation of key business value. |I -  if the opportunity is for an existing customer|C,I -  if the opportunity is for an existing customer|C,I||DRI|||||
