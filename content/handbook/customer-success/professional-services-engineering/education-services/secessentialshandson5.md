...
1. Paste this Python fuzz target code into a new file called `FuzzTarget.py` in the root of your project. The comments explain each line of the fuzz target code.
   ...
   > This fuzz target is typical for Python-based fuzz testing. See the [GitLab documentation](https://docs.gitlab.com/user/application_security/coverage_fuzzing/#supported-fuzzing-engines-and-languages) for instructions on writing fuzz targets for other languages.
...
Want to keep a copy of your project to practice with later? You can [export](https://docs.gitlab.com/user/project/settings/import_export/#export-a-project-and-its-data) it to a ZIP file or [transfer](https://docs.gitlab.com/user/project/settings/migrate_projects/#transfer-a-project-to-another-namespace) it to your personal namespace.
