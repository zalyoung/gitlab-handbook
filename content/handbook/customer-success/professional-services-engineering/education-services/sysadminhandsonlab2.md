...
The objective of this lab is to show various gitlab-ctl commands you can use to manage your GitLab instance via the CLI. These commands can be run after installation. See a [full list of all the commands you can use with gitlab-ctl](https://docs.gitlab.com/omnibus/maintenance/)
