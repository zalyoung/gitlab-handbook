...
The objective of this lab is to guide you on managing your GitLab logs via the `gitlab-ctl` and `sed` commands. For more information, see the [GitLab logging documentation](https://docs.gitlab.com/ee/administration/logs/).
