...
- The directions do not use a [bulk edit](https://docs.gitlab.com/user/project/issues/managing_issues/#bulk-edit-issues-from-a-project) due to [this epic search issue](https://gitlab.com/gitlab-org/gitlab/-/issues/233729).
...
- For each issue in the to-be-recreated epic:
  - Browse to the issue
    - Use the `/epic <url>` [slash command](https://docs.gitlab.com/user/project/quick_actions/) to move the issue to the new epic
