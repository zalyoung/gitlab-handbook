...
- Follow these steps to get the Authorization signed:
   1. Locate and download the template in GitLab's G-Drive [here] (https://docs.google.com/document/d/1utvdSknJ0hm5m0_6T9SkeXaFqJSZgB6w/copy) (*Note* this is only available to GitLab employees).
