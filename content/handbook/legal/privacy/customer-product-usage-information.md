...
*Types of Data*: The Metrics collected include name, email, hostname and company of the individual listed on the paid Self-Managed or Dedicated license, as well as those Metrics listed [here](https://docs.gitlab.com/subscriptions/self_managed/#subscription-data).
