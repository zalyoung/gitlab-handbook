...
- [Trademark Guidelines](/handbook.gitlab.com/handbook/marketing/brand-and-product-marketing/brand/brand-activation/trademark-guidelines/)
- [Brand Guidelines](/design.gitlab.com/)

## Process for New GitLab Trademarks

If considering a new trademark, review the following:

- [The naming process at GitLab](/handbook.gitlab.com/handbook/marketing/brand-and-product-marketing/brand/naming/#the-naming-process)
- [Product and feature naming guidelines](/handbook.gitlab.com/handbook/product/product-principles/#product-and-feature-naming-guidelines)
...
3. [Contact GitLab Legal](/handbook.gitlab.com/handbook/legal/#how-to-reach-us) to obtain approval for any **modifications** the third party requests to the Authorization.

4. Assign the Authorization for countersignature via DocuSign to an appropriate GitLab team member identified in the [Signature Authorization Matrix](/handbook.gitlab.com/handbook/finance/authorization-matrix/#authorization-matrix).
...
For information on use of third-party IP in external materials, see our [Guidelines for Use of Third-party IP in External Materials](/handbook.gitlab.com/handbook/legal/ip-public-materials-guidelines/).
