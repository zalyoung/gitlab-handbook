...
1. Select the "Legal Request" button in the drop down menu at the upper right corner of the customer's opportunity in SFDC (or at the account level if the query is related to a partner). **If an opportunity does not exist, please open a $0 opportunity and then create the Legal Request from such opportunity, following the steps set out in this section.** 
...
1. Step-by-step directions on opening a Legal Request is shown in [this video] (https://youtu.be/Zalqiadqwvk), as well as described below.
    ...
    - Choose the most appropriate answers for each field in the drop-down menu, add all relevant details in the "Notes" Section and upload any related document, then hit "Submit". **Please add as many details as possible and include urgency of the request or deadline, as this will allow the Legal team member to plan and prioritize accordingly.**
    - Once properly submitted, a new legal request will be added to the Legal team's queue and the appropriate team member will assign the case to themselves to assist you.
...
1. For more information and instructions, plesase see the [Trade Compliance Handbook page](https://internal.gitlab.com/handbook/sales/sales-operations/#trade-compliance-navex-risk-rate). 
...
1. Sales/Ecosystems opens a Legal Request in SFDC.
...
1. For **change of control**, Legal confirms transaction category (acquisition, divestiture, asset sale, merger, insolvency).
