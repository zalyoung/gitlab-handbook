...
**3.3** GitLab incorporates commonly used tracking technologies such as cookies and pixels to gather insights about how visitors engage with the Content. This includes the use of session replay tools, which may automatically capture personal data through cookies and other scripts, as well as behavioral information such as keystrokes and scrolling patterns. The use of cookies, pixels, and session replay tools can be blocked on your browser when you make use of available opt-out mechanisms described in our [Cookie Policy](https://about.gitlab.com/privacy/cookies/). When the Website does not detect a signal or indication from your browser that cookies or other technologies should be blocked, then your use of the Website and our collection of personal data through cookies, pixels, session replay and other similar technologies is deemed to be with your consent. If you reside in a jurisdiction where cookies and similar technologies are toggled off by default (such as in the European Union), then no cookies, pixels, session replay or other similar technologies will fire unless you affirmatively inform us that you wish to allow their use on your browser.
