...
We use ZenDesk to create, modify, and  publish knowledge base articles.   If you are NOT a ZenDesk User, and want to create a knowledge article, you can do so externally!  Follow the process below.
