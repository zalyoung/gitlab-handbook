...
**This table provides an overview of what we are working through**

| Feature                            | Status           |
|:----------------------------------- | :---------------|
|Local Repository using Markdown      | Investigating   |
|What are working on for SWIR         | Investigating   |
|Add Internal comments to articles    | Investigating   |
|Markdown not working on copy/paste   | Investigating   |
|Update Search Fitlers /streamline    | Investigating   |
|Add Published articles to Slack      | Investigating   |
|US Governmanet knowledge articles    | Investigating   |
|Article suggestions in articles      | Investigating   |
|Article Review process for relevancy | Investigating   |
|KCS Dashboard Metrics                | Investigating   |
|Content Standards AQI                | Investigating   |
