...
You can see `Account Locked` states in [Kibana](/handbook/handbook/support/workflows/kibana/) by searching for `json.message: Account Locked`. Here's an example of what it might look like it Kibana:
...
1. For other cases, [comment or create an issue](/handbook/handbook/support/workflows/working-with-issues/) as applicable.
1. Do an [account ownership verification](/handbook/handbook/support/workflows/account_verification/).
...
1. [Add an admin note](/handbook/handbook/support/workflows/admin_note/).
...
If a ticket was not automatically worked, Support can manually unblock the user in the following cases:
    ...
    - For [Enterprise users](/handbook/handbook/support/workflows/gitlab-com_overview/#enterprise-users), the `owner` of the top-level namespace the user belongs to can submit the ticket. Follow the [account verification](/handbook/handbook/support/workflows/account_verification/), and add an [admin note](/handbook/handbook/support/workflows/admin_note/) as usual, including if it was user or owner requested.
