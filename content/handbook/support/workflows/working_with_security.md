...
- If the report appears to be a valid security issue, or if in doubt:
  - If the severity may be an ~severity::1 or otherwise needs immediate investigation:
    ...
    - Manually create an issue for report following the [creating a security issue instructions](/handbook/security/security-operations/sirt/engaging-security-on-call/)
  - Otherwise, reply to the reporter to see if they wish to either:
    - Report via HackerOne
    - Create a confidential issue themselves following the [creating a security issue instructions](/handbook/security/security-operations/sirt/engaging-security-on-call/)
...
See [Creating New Security Issues](/handbook/security/security-operations/sirt/engaging-security-on-call/)
