...
1. (Optional) When the required information has been collected, the assignee can reach out to any of the folks with an `Upgrade` or `Upgrade Assistance` focus on the [Skills by Subject](http://gitlab-com.gitlab.io/support/team-pages/skills-by-subject.html?search=Upgrade) page to pair or offer insight asynchronously.
