...
1. **For customers with ARR above $100,000 USD**: A Senior Support Engineer (preferably one with expertise in upgrades) and a manager must approve the upgrade plan. If a Senior SE is the original reviewer, they only need one other person to approve the plan, which can either be another Senior SE or a manager. 
