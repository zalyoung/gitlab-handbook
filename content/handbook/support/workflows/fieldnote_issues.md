...
At GitLab, [Support are encouraged to raise Issues](/handbook/handbook/support/workflows/working-with-issues/) and Merge Requests for Customer Tickets. This *Fieldnotes* Project in no way should replace that. If it's appropriate to raise an Issue in some other relevant Project, then continue to do that following the normal Workflow, and close this project's Fieldnote Issue with a link to the correct one.
