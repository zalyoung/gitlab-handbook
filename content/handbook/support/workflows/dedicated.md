...
- If you're dealing with an Application issue i.e. the issue is within the GitLab application, then you can treat it like a Self-Managed instance
- If it's an infrastructure issue, then you'll want to look to our runbooks and consider opening a [Request for Help](https://gitlab.com/gitlab-com/request-for-help/-/issues/new?issuable_template=SupportRequestTemplate-GitLabDedicated)
