...
#### Paid Users
Paid Users are recommended to wait for GitLab to automatically delete the account, however it is possible for Support to update the email address of paid users with manager approval.
