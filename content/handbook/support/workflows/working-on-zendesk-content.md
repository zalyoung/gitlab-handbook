...
- If you want to deactivate a macro, use the [Support Super Form](https://support-super-form-gitlab-com-support-support-op-651f22e90ce6d7.gitlab.io/) 'Edit a Zendesk macro' option.
  - **NOTE** If the macro has a managed content file, please **only** deactivate the file after Support Ops confirms the macro has been deactivated in Zendesk. This step is important to prevent sync errors in the ZD Macro repo. 
