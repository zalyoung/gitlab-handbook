...
To transfer compute minutes from a user's personal namespace to a group namespace, use the [Force Association option in the ZD Mechanizer App](/handbook/handbook/support/license-and-renewals/workflows/customersdot/mechanizer/#force-associate).
...
Use the [Enable compute minutes via ZD Mechanizer app](/handbook/handbook/support/license-and-renewals/workflows/customersdot/mechanizer/#enable-units-of-compute).
