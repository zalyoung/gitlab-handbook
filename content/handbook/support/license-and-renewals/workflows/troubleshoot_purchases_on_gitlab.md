...
🔧 To fix the problem, Customer X needs to log in to their [Customers Portal](https://customers.gitlab.com/customers/sign_in) account and [link their GitLab account](https://docs.gitlab.com/ee/subscriptions/customers_portal/#change-the-linked-account).
...
🔧 To fix the problem, Customer Y needs to log in to their [Customers Portal](https://customers.gitlab.com/customers/sign_in) account and [link their GitLab account](https://docs.gitlab.com/ee/subscriptions/customers_portal/#change-the-linked-account).
...
- [Change the linked GitLab account](https://docs.gitlab.com/ee/subscriptions/customers_portal/#change-the-linked-account) to the GitLab account with email <customerZ@example.com>
...
1. If the namespace is on a paid plan, request the user to:
   ...
   1. [Link their GitLab account](https://docs.gitlab.com/ee/subscriptions/customers_portal/#change-the-linked-account)
...
- [Users API](https://docs.gitlab.com/ee/api/users/#for-normal-users): Search for user using their email or username
