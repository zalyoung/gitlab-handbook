...
Customers can instead [follow these steps](https://docs.gitlab.com/ee/subscriptions/customers_portal/#sign-in-to-customers-portal) to log in using a one-time sign-in link.
