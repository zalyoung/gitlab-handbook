...
1. Check if the CustomersDot account is linked to a GitLab.com account:
      ...
      - [Unlink GitLab.com Account mechanizer function](/handbook/handbook/support/license-and-renewals/workflows/customersdot/mechanizer/#unlink-gitlabcom-account).
