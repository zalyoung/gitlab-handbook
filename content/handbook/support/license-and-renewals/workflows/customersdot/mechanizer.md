...
For example, to add 1000 units to namespace with a total of 6000 Additional Compute Units, set the "Extra amount of units of compute" field to 7000.   (***Note:** This will update the 'Additional compute minutes' value.* )
