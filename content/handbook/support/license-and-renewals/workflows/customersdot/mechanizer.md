...
Sets [additional project storage](https://docs.gitlab.com/ee/user/usage_quotas/#excess-storage-usage) for a namespace to the value specified in the `Extra storage (MiB)` field
