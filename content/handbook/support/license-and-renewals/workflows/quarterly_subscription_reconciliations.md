...
- Follow the workflow on [Working with Sales](/handbook/handbook/support/license-and-renewals/workflows/working_with_sales/#general-workflow) to inform the account manager in SFDC.
