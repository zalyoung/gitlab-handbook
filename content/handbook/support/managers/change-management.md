...
As soon as possible, create the documentation MR(s) and/or [companion issues for Customer Support Operations](/handbook/support/workflows/working_with_customer_support_operations) to present the actual proposed changes.
