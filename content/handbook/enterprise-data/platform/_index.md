...
In order to be granted access to a Snowflake analyst role, utilize a [Lumos Access Request](/handbook/security/corporate/systems/lumos/ar/). A new user will be created with access to query the `PROD` database.
