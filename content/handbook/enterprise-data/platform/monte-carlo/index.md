...
The only two ways of influencing the underlying model are described in [Training data section of the Monte Carlo documentation](https://docs.getmontecarlo.com/docs/tuning-thresholds#training-data) and are:  
