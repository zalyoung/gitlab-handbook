...
| 6.   | [2024-10-11 - 2024-10-16 missing Snowplow events (gitlab_saas_duo_pro_namespace_ids)](https://gitlab.com/gitlab-data/analytics/-/issues/21943) | Snowplow | Wrong format for the column `gitlab_saas_duo_pro_namespace_ids` (no big impact, column was formatted as string instead of number) | `2024-10-11` - `2024-10-16`                                                               |
| 7.   | [Customer questions (red data) leaking into product analytics data](https://gitlab.com/gitlab-org/gitlab/-/issues/503275) | Snowplow | Exposed red data for the `category` and `detailed_category` value in Snowflake.                                                   | `2023-10-23` - `2024-12-02`                                                               |
| 8.   | [Snowflake: Pseudonymize page_url_path in Snowflake and s3 bucket](https://gitlab.com/gitlab-data/analytics/-/issues/22197) | Snowplow | Exposed data for the `page_url_path` column in Snowflake.                                                                         | `2022-10-01` - `2025-01-01`                                                               |
| 9.   | [s3: Pseudonymize page_url_path in Snowflake and s3 bucket](https://gitlab.com/gitlab-data/analytics/-/issues/22351) | Snowplow | Exposed data for the `page_url_path` column in the `s3` bucket.                                                                   | `2022-10-01` - `2025-01-01`                                                               |
| 10.  | [AI Gateway SSOT data source missing namespaces in events related to 'request_duo_chat_response'](https://gitlab.com/gitlab-org/gitlab/-/issues/507389) | Snowplow | Wrong namespace assigned for `request_duo_chat_response`                                                                          | `2024-08-28` - `2024-12-04`                                                               |
| 11.  | [Submitting Service Ping causes validation error in Version app for v17.6 SM instances](https://gitlab.com/gitlab-org/gitlab/-/issues/508580) | Snowplow | Lower than usual amount of successful Service Ping and large number of submission fails                                           | `2024-10-04` - `2024-12-16`                                                               |
