...
We do this by helping all GitLab teams move up the [**Data Value Pyramid**](/handbook/enterprise-data/organization/direction/#data-value-pyramid) **by means of our** [**GitLab values**](/handbook/values/) and our [**Data Team Principles**](/handbook/enterprise-data/#data-team-principles).
...
**Analytics** is the practice of turning **data** into [**information, knowledge, and wisdom**](/handbook/enterprise-data/organization/direction/#data-value-pyramid) to:
...
Our short term goal for `FY21-2H` is to move GitLab up the [**Data Capability Model**](/handbook/enterprise-data/organization/direction/#data-capability-model) from **Level (1) Reactive** to **Level (2) Advanced**.
