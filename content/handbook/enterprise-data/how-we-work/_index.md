...
| `workflow::2 - waiting for prioritization` | Data              | The issue is scoped, sized and warrants development. | There is bandwidth to pick up this work in the short term. |
