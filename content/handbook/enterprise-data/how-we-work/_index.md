...
| `workflow::3 - ready to develop`  | Data               | The issue is fully scoped & weight applied                  | Work is picked up for refinement and development  |
| `workflow::4 - refinement`        | Data, Business DRI | The issue is actively being refined         | Technical solution is included in the issue. The technical solution should have enough detail and clarity that another developer (other than the one doing the validation) would be able to pick it up. |
