...
everyone is encouraged to set the deadline based on the date of the last severity label update and [the SLA for the given severity](/handbook/product-development/issue-triage/#severity-slos).
...
1. GitLab Issue triage procedure: we have a handbook section we can follow
   [here](/handbook/product-development/issue-triage/#priority)
...
- Reprioritazation will have a dedicated section in the milestone planning
  issue.
- Outdated bugs are closed in accordance with [the existing handbook practice](/handbook/product-development/issue-triage/#outdated-issues)

###### Best practices

- Read the issue triage [handbook page](/handbook/product-development/issue-triage/)
