...
Any GitLab team-member can triage issues. Keeping the number of [un-triaged issues](/handbook/product-development/issue-triage/#triaging-issues) low is essential for maintainability, and is our collective responsibility.
...
* [Priority labels](/handbook/product-development/issue-triage/#priority)
* [Severity labels](/handbook/product-development/issue-triage/#severity)
...
The goal is to achieve [complete-triage](/handbook/product-development/issue-triage/#complete-triage) by the Product Manager, Engineering Manager, UX team member in that area.
...
* Triage actions:
  ...
  1. Assign a [Priority Label](/handbook/product-development/issue-triage/#priority).
  1. Assign a [Severity Label](/handbook/product-development/issue-triage/#severity).
...
guidelines at
<https://handbook.gitlab.com/handbook/product-development/issue-triage/#availability-prioritization>
...
Issues which have a severity label and missed the [SLO target](/handbook/product-development/issue-triage/#severity) will be labeled with `~missed-SLO`. The calculation for elapsed time starts from the date of the severity label was applied. This enables reporting on SLO target adherence.
...
Bugs have a severity label that indicates the [SLO for a fix](/handbook/product-development/issue-triage/#severity). This automated policy aims to prompt managers about bugs in their group that are approaching the SLO threshold
...
Issues with the ~infradev label should have a [severity label](/handbook/product-development/issue-triage/#severity), a [priority label](/handbook/product-development/issue-triage/#priority), and a milestone set. This automated policy aims to prompt managers about such issues missing one of these attributes.
...
Issues with the ~customer and ~type::bug labels should have a [severity label](/handbook/product-development/issue-triage/#severity) set. This automated policy aims to prompt team members to set a severity so that ~customer bugs are triaged in a timely fashion.
...
* [Issue Triage Policies](/handbook/product-development/issue-triage/).
