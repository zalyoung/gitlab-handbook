...
- Assign a [group label](#group-labels).
  - If there is no suitable group label: assign a [stage ("devops") label](https://docs.gitlab.com/ee/development/labels/#stage-labels).
...
- It has a [priority label](https://docs.gitlab.com/ee/development/labels/#priority-labels) applied for `~"type::bug"` and `~"Deferred UX"`.
...
Assigning a [group label](https://docs.gitlab.com/ee/development/labels/#group-labels) allows `gitlab-bot` to automatically assign the right stage label.
...
[Severity labels](https://docs.gitlab.com/ee/development/labels/#severity-labels) help us determine urgency and clearly communicate the impact of a `~"type::bug"` on users. There can be multiple categories of a `~"type::bug"`.
...
- What labels apply? Particularly consider [type, stage and severity](https://docs.gitlab.com/ee/development/labels/) labels.
...
Some issues may not fall into the [type labels](https://docs.gitlab.com/ee/development/labels/#type-labels), but they contain useful feedback on how GitLab features are used.
