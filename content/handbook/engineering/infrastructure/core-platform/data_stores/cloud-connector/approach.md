...
* [The GitLab performance docs](https://docs.gitlab.com/development/performance/)
...
the design by moving to [batch insertions](https://docs.gitlab.com/development/database/insert_into_tables_in_batches/) instead.
...
[`in_batches` helper](https://docs.gitlab.com/development/database/iterating_tables_in_batches/), but the idea applies to
...
[copy-on-write](https://en.wikipedia.org/wiki/Copy-on-write).) Again, [migrating from Unicorn to Puma](https://docs.gitlab.com/administration/operations/puma/) was an example of this
...
even be auto-corrected because it's a one-liner. A good example for this is the file I/O API, which offers [faster variants of certain methods](https://docs.gitlab.com/development/performance/#reading-from-files-and-other-data-sources)
