...
| [`GitLab Data Seeder`](https://docs.gitlab.com/ee/development/data_seeder.html) | Data seeding harness that can seed customized data directly into a user or group namespace using low-level ORM calls |
