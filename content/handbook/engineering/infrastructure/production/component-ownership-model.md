...
Infrastructure Platforms and Application Ownership Teams will both commit to maintaining the following SLAs.
...
#### Component Owner SLAs

1. **Security Incident Response**:
    - Critical vulnerabilities (CVSS 9.0+): 24 hours for mitigation, 72 hours for fix
    - High vulnerabilities (CVSS 7.0-8.9): 7 days
    - Medium vulnerabilities (CVSS 4.0-6.9): 30 days
    - Low vulnerabilities (CVSS <4.0): 90 days
    - Embargoed vulnerabilities: Must comply with coordinated disclosure timelines
...
1. **Operational Response**:
    - Production incidents (S1/S2): 30-minute response time
    - Performance degradation: 1 hour response time
    - Capacity alerts: X business days

1. **Documentation Maintenance**:
    - Runbook updates: Within 7 days of significant changes
...
1. The team will need to maintain their own Pagerduty Schedule for escalations to the service.
