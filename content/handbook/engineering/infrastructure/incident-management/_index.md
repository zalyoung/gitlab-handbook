...
| ---- | ----------- | ---- | ---- |
| **Engineer On Call (EOC)** | Primarily serves as Incident Responder | GitLab.com | Generally an SRE and can declare an incident. Part of the "SRE 8 Hour" on call shift in PagerDuty. |
