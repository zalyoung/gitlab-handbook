...
- `time_to_staging-canary`: The package containing the MR is being deployed to [staging canary](/handbook/engineering/infrastructure/environments/#staging-canary) and [staging ref](/handbook/engineering/infrastructure/environments/#staging-ref). QA smoke tests have run successfully.
- `time_to_canary`: The package containing the MR is being deployed to [canary](/handbook/engineering/infrastructure/environments/#production-canary).
...
- `time_to_staging`: The package containing the MR is being deployed to the [staging environment](/handbook/engineering/infrastructure/environments/#staging)
- `time_to_prod`: At the end of this stage, the package containing the MR has been successfully deployed to the [production environment](/handbook/engineering/infrastructure/environments/#production)
