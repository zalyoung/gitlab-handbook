...
We dogfood the [weight feature](https://docs.gitlab.com/user/project/issues/issue_weight/) in issues. We use a modified Fibonacci sequence (the numbers match roughly with the number of days) and align our weights to t-shirt sizes to make them easy to talk about:
