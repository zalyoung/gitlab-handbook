...
[here](https://docs.gitlab.com/development/internal_analytics/internal_event_instrumentation/quick_start/#quick-start-for-internal-event-tracking)
...
You should follow the process Analytics Instrumentation has defined in the [quick start guide](https://docs.gitlab.com/development/internal_analytics/internal_event_instrumentation/quick_start/#quick-start-for-internal-event-tracking).
linked docs.
...
[Database metrics](https://docs.gitlab.com/development/internal_analytics/metrics/metrics_instrumentation/#database-metrics),
...
We have a Rails
[generator](https://docs.gitlab.com/development/internal_analytics/metrics/metrics_instrumentation/#create-a-new-metric-instrumentation-class)
...
1. Use the schema defined [here](https://docs.gitlab.com/development/internal_analytics/metrics/metrics_dictionary/).
