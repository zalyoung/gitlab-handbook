...
We follow the [GitLab team members Guide to Time Off](/handbook/people-group/paid-time-off/#a-gitlab-team-members-guide-to-time-off) and the engineering process to [create PTO Coverage](https://handbook.gitlab.com/handbook/engineering/#1-creating-an-engineering-coverage-issue) issues. PTO Coverage issues are recommended for 3 days or more. 
