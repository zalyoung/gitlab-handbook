...
When issues require a design proposal, we follow the [Product Development Flow](/handbook/product-development/how-we-work/). Design and development should work together from the start to ensure the issue follows our [MVC guidelines](/handbook/product/product-principles/#the-minimal-valuable-change-mvc), while still providing value and a usable experience.
...
Unless specifically mentioned below, the Software Supply Chain Security:Pipeline Security group follows the standard [engineering](/handbook/engineering/workflow/), [product](/handbook/product-development/how-we-work/), and [UX](/handbook/product/ux/product-designer/) workflows.
