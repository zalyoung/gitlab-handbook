...
1. Compliance merge requests use feature flags where it makes sense to reduce risk. We follow the [Feature Flag Lifecycle](/handbook/product-development/how-we-work/) as closely as possible. For extended or multi–merge request development, all work should remain behind a dedicated feature flag. This approach allows incremental changes to be merged safely, keeping incomplete functionality off for production users.
...
Testing is an essential part of our [product development workflow](/handbook/product-development/how-we-work/) and
...
We generally follow the [Product Development Flow](/handbook/product-development/how-we-work/):
