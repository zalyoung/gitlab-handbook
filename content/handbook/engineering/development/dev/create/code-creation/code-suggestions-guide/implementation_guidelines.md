...
[Direct Connections API endpoint](https://docs.gitlab.com/ee/api/code_suggestions/#fetch-direct-connection-information).
...
[Code Completions API endpoint](https://docs.gitlab.com/ee/api/code_suggestions/#generate-code-completions).
...
- [Direct Access endpoint](https://docs.gitlab.com/ee/api/code_suggestions/#fetch-direct-connection-information) -
for direct-to-AIGW requests, this endpoint provides the information necessary to send a request to AIGW
- [Code Suggestions endpoint](https://docs.gitlab.com/ee/api/code_suggestions/#generate-code-completions) -
...
- On GitLab SaaS, the flag will be checked against the _top-level group_ that is providing the user with the [GitLab Duo Add-on](https://docs.gitlab.com/ee/subscriptions/subscription-add-ons/) seat.
