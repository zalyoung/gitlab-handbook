...
- [Code Review Workflow](https://about.gitlab.com/stages-devops-lifecycle/create/), mainly the [Merge Requests](https://docs.gitlab.com/user/project/merge_requests/) features
...
will eventually be turned into an onboarding [issue template](https://docs.gitlab.com/user/project/description_templates/#create-an-issue-template).
