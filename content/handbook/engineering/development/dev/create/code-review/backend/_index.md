...
- [Code Review onboarding template for Backend Engineers](https://gitlab.com/gitlab-com/create-stage/code-review-be/-/blob/main/.gitlab/issue_templates/onboarding.md).
