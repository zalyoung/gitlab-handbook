...
1. [Plan](/handbook/product/categories/#plan-stage)
    - [Plan:Project Management](/handbook/engineering/devops/dev/plan/project-management/)
    - [Plan:Product Planning](/handbook/engineering/devops/dev/plan/product-planning/)
    - [Plan:Optimize](/handbook/engineering/development/analytics/monitor/optimize)
    - [Plan:Editor](/handbook/engineering/devops/dev/plan/editor/)
1. [Create](/handbook/product/categories/#create-stage)
    - [Create: Source Code BE](/handbook/engineering/devops/dev/create/source-code/backend/)
    - [Create: Source Code FE](/handbook/engineering/devops/dev/create/source-code/frontend/)
    - [Create: Code Review BE](/handbook/engineering/devops/dev/create/code-review/backend/)
    - [Create: Code Review FE](/handbook/engineering/devops/dev/create/code-review/frontend/)
    - [Create: Remote Development](/handbook/engineering/devops/dev/create/remote-development/)
    - [Create: Code Creation](/handbook/engineering/devops/dev/create/code-creation/)
    - [Create: Editor Extensions](/handbook/engineering/devops/dev/create/editor-extensions/)
