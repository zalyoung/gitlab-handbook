...
**Data flow for [Group contribution analytics](https://docs.gitlab.com/user/group/contribution_analytics) & [Group value stream dashboard contributions](https://docs.gitlab.com/user/analytics/value_streams_dashboard/)**
...
**Data flow for [Group/Project AI Impact Analytics](https://docs.gitlab.com/user/analytics/ai_impact_analytics/)**
