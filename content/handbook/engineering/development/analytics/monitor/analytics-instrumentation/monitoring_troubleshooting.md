...
[Declare an official incident](https://docs.gitlab.com/ee/operations/incident_management/slack/#declare-an-incident) with severity S4 and `gitlab` as the project to get their attention.
...
To alert the SRE on-call [declare an official incident](https://docs.gitlab.com/ee/operations/incident_management/slack/#declare-an-incident) with severity S4 and `gitlab` as the project.
