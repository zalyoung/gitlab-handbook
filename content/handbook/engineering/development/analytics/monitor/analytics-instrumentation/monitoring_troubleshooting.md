...
3. Add the [severity::1](/handbook/product-development/issue-triage/#severity) and [Analytics Instrumentation::Incident-High Severity](/handbook/engineering/development/analytics/monitor/analytics-instrumentation/#incident-creation) labels
