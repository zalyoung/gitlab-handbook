...
| Project | API |
|---------| --- |
| [GitLab Terraform Provider](https://gitlab.com/gitlab-org/terraform-provider-gitlab) | [REST API](https://docs.gitlab.com/api/api_resources/) |
| [GitLab CLI](https://gitlab.com/gitlab-org/cli) | [REST API](https://docs.gitlab.com/api/api_resources/) |
...
We follow the [merge request author responsibility guidelines](https://docs.gitlab.com/development/code_review/#the-responsibility-of-the-merge-request-author).

#### The responsibility of Reviewers and Maintainers

We follow the [code review guidelines](https://docs.gitlab.com/development/code_review/#the-responsibility-of-the-reviewer).
...
Our code review process follows the [general process](https://docs.gitlab.com/development/code_review/)
