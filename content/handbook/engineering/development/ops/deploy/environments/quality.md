...
The goal of this page is to document how the Environments group uses the [GitLab QA framework](https://gitlab.com/gitlab-org/gitlab-qa) ([video walkthrough](https://www.youtube.com/watch?v=enfx6tiz5WY)) to implement and run [end-to-end tests](https://docs.gitlab.com/development/testing_guide/end_to_end/).
...
The testing strategy for [this level of the pyramid](https://docs.gitlab.com/development/testing_guide/testing_levels/) can be found under the [Environments Test Plan](https://gitlab.com/groups/gitlab-org/-/epics/8642) epic.
...
- [Testing Guide - End-to-End Testing](https://docs.gitlab.com/development/testing_guide/end_to_end/)
