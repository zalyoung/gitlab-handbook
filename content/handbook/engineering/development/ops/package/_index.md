...
- [Container Registry Documentation](https://docs.gitlab.com/user/packages/container_registry/)
- [Package Registry Documentation](https://docs.gitlab.com/user/packages/package_registry/)
