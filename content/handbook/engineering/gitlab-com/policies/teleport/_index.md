...
- Teleport access is managed through [Okta](/handbook/security/corporate/it/okta/) and is provided as part of a role's baseline group assignment or through an [access request](/handbook/security/corporate/services/access-requests/) with appropriate approval
