...
5. Issue Labels
    ...
    - The Engineering Manager adds the ["Deliverable" label](/handbook/product-development/how-we-work/) to items we commit to focusing on in this milestone
...
- **Label Updates**: It's crucial for engineers to update the ["workflow" labels](/handbook/product-development/how-we-work/) accurately as issues progress from "ready for development" to "in dev" to "in review."
