...
1. For any incoming message for a sentry error try to find out:
   ...
   1. Depending on that either:
      1. Create a new issue.
         ...
         1. If it turns out to be a [severity 1 issue](/handbook/product-development/how-we-work/issue-triage/#severity), then announce it in Slack, to coordinate work on it.
