...
if they use [`git clone`](https://docs.gitlab.com/ee/ci/pipelines/settings/#choose-the-default-git-strategy),
...
[pack-objects](https://docs.gitlab.com/ee/administration/gitaly/configure_gitaly/#pack-objects-cache),
