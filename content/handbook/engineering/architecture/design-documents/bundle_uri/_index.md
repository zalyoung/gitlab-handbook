...
if they use [`git clone`](https://docs.gitlab.com/ci/pipelines/settings/#choose-the-default-git-strategy),
...
[pack-objects](https://docs.gitlab.com/administration/gitaly/configure_gitaly/#pack-objects-cache),
