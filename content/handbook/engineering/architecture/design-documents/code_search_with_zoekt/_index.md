...
1. Zoekt most likely will use [Internal API](https://docs.gitlab.com/ee/development/internal_api/) to connect to GitLab. We might also want to use a separate GitLab URL to keep the traffic internal and to avoid extra traffic cost.
...
- ..[Internal API](https://docs.gitlab.com/ee/development/internal_api/
