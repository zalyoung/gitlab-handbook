...
environments. The [Cloud Connector](https://docs.gitlab.com/architecture/blueprints/cloud_connector/)'s API-based approach would generally address the missing deployment solution
...
along with deployment instructions with the customers (similar to [custom models approach](https://docs.gitlab.com/architecture/blueprints/custom_models/#ai-gateway-deployment)) but the horizontal
