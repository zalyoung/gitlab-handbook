...
environments such as GitLab.com. The [developer database migration style guide](https://docs.gitlab.com/development/migration_style_guide/)
provides guidelines on migrations, and we focus on validating migrations during code review and testing
in CI and staging.

The [code review phase](https://docs.gitlab.com/development/database_review/) involves
