...
Provide a means to accelerate delivery of features, especially to cloud native capable Self-Managed users. Do this, while not forcing excessive change or pressure upon our existing customer install based which demonstrably favor some variation of Omnibus's use on traditional infrastructure as a percentage of total paid and unpaid install base.
...
- Forcibly converting traditional Omnibus into cloud native "under the hood".
- Unexpectedly increase customer infrastructure costs and consumption.
- Alienate customers of any kind, by forcing large architectural refactors upon them.
