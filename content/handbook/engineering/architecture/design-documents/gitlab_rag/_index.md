...
If one of the existing [indexed document types](https://docs.gitlab.com/integration/advanced_search/elasticsearch/#advanced-search-index-scopes)
is not covered, a [new document type](https://docs.gitlab.com/development/advanced_search/#add-a-new-document-type-to-elasticsearch) can be added.
...
Elasticsearch provides blob search which supports [Advanced Search Syntax](https://docs.gitlab.com/user/search/advanced_search/#syntax).

[Zoekt](https://docs.gitlab.com/architecture/blueprints/code_search_with_zoekt/) is employed on GitLab.com to provide
...
- [Data privacy](https://docs.gitlab.com/user/gitlab_duo/data_usage/#data-privacy)
- [Data retention](https://docs.gitlab.com/user/gitlab_duo/data_usage/#data-retention)
- [Training data](https://docs.gitlab.com/user/gitlab_duo/data_usage/#training-data)
