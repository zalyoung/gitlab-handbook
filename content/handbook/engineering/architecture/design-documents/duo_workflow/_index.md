...
The composite OAuth token will belong to a [service account](https://docs.gitlab.com/ee/user/profile/service_accounts/)
...
1. Tools to integrate with the [GitLab HTTP API](https://docs.gitlab.com/ee/api/api_resources/).
