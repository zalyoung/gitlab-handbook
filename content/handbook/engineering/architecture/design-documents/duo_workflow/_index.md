...
abstract Duo Workflow away from `.gitlab-ci.yml` syntax.
...
1. Using CI Pipelines also introduces some security challenges we will iterate
   on before releasing to users.
