...
1. **Remove STI**: We still use [single-table inheritance](https://docs.gitlab.com/development/database/single_table_inheritance/) in a few places, which is considered an anti-pattern. Redesigning this, we can split data into multiple tables.
