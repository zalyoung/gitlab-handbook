...
- Indexes introduce additional [maintenance overhead](https://docs.gitlab.com/ee/development/database/adding_database_indexes/#maintenance-overhead), including:
  - Write amplification
