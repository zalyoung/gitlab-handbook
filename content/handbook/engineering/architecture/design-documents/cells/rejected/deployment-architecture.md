...
This could be achieved with testing Cells on top of the [Reference Architectures](https://docs.gitlab.com/administration/reference_architectures/).
...
- Additional Cells are deployed, upgraded and maintained via a [GitLab Dedicated-like](https://docs.gitlab.com/subscriptions/gitlab_dedicated/) control plane.
...
- The Routing Service is expanded to support [GitLab Pages](https://docs.gitlab.com/user/project/pages/) and [GitLab container registry](https://docs.gitlab.com/user/packages/container_registry/).
