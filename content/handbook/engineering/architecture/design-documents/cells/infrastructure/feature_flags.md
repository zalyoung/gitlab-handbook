...
- ChatOps - [ChatOps commands](https://docs.gitlab.com/development/feature_flags/controls/)
...
Feature flags can be set on a GitLab instance through the [feature flag API](https://docs.gitlab.com/api/features/),
