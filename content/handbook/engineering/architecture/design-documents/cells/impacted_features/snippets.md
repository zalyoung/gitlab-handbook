...
- [Project snippets](https://docs.gitlab.com/api/project_snippets/). These snippets have URLs
  like `/<group>/<project>/-/snippets/123`
- [Personal snippets](https://docs.gitlab.com/user/snippets/). These snippets have URLs like
  `/-/snippets/123`
...
- We will break [snippet discovery](https://docs.gitlab.com/user/snippets/#discover-snippets).
