...
A [personal Namespace](https://docs.gitlab.com/user/namespace/#types-of-namespaces) is based on a username and provided when a user creates an account.
Users can create [personal Projects](https://docs.gitlab.com/user/project/working_with_projects/#view-personal-projects) under their personal Namespace.
...
- [Converting personal Namespaces to Groups](https://docs.gitlab.com/tutorials/convert_personal_namespace_to_group/) before transfer is not a straightforward process.
