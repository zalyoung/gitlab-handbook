...
- Minimum size of `<base64-payload>` is 27 bytes (20 bytes before encoding: `(min size of <random-bytes>) + (min size of <routing-payload>) + (size of <random-bytes-length>) = 3 + 16 + 1 = 20`)
