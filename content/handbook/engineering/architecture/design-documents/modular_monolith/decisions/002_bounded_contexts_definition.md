...
- Bounded contexts (top level modules) should be [sufficiently deep](https://docs.gitlab.com/ee/development/software_design/#use-namespaces-to-define-bounded-contexts)
...
We defined a list of [bounded contexts in code](https://docs.gitlab.com/ee/development/software_design/#use-namespaces-to-define-bounded-contexts)
