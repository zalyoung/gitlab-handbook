...
{{% alert %}}
This decision is scoped to code completion requests. Code completion requests are a type of [code suggestion request](https://docs.gitlab.com/ee/user/project/repository/code_suggestions/).
{{% /alert %}}
