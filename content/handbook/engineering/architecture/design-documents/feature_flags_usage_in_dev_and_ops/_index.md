...
[591 feature flags in the GitLab codebase](https://docs.gitlab.com/user/feature_flags/).
...
- [User documentation](https://docs.gitlab.com/user/feature_flags/):
...
- `gitlab_com_derisk`
  ...
  - Additional note: This type of feature flag won't be documented in the [All feature flags in GitLab](https://docs.gitlab.com/user/feature_flags/)
