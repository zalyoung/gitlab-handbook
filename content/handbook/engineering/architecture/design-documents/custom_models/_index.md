...
- [Docker](https://docs.gitlab.com/administration/self_hosted_models/install_infrastructure/#install-by-using-docker)
- [Helm Chart](https://docs.gitlab.com/administration/self_hosted_models/install_infrastructure/#install-by-using-the-ai-gateway-helm-chart)
...
The list of supported LLMs are available in the [documentation](https://docs.gitlab.com/administration/self_hosted_models/supported_models_and_hardware_requirements/#approved-llms).
...
customers can host their own [LLMs](https://docs.gitlab.com/administration/self_hosted_models/install_infrastructure/)
