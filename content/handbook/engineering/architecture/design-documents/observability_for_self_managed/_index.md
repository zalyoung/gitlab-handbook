...
- **Move Observability APIs to GitLabs [project resource API](https://docs.gitlab.com/api/api_resources/#project-resources).**
...
All observability APIs will proxy through Workhorse and will live under GitLabs [project resource](https://docs.gitlab.com/api/api_resources/#project-resources).
