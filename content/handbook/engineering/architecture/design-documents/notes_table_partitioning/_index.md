...
- Addresses [polymorphic associations](https://docs.gitlab.com/ee/development/database/polymorphic_associations/)
...
could be [partitioned by int range](https://docs.gitlab.com/ee/development/database/partitioning/int_range/)
