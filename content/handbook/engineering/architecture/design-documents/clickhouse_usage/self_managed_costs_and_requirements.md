...
GitLab Reference Architecture sizes and [costs](https://docs.gitlab.com/ee/administration/reference_architectures/#cost-calculator-templates) from the GCP calculator.
