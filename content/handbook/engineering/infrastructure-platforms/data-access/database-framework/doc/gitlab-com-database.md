...
1. Retrieve query plans through [ChatOps on Slack](https://docs.gitlab.com/development/database/understanding_explain_plans/#chatops)
1. Use [`#database-lab` Slack channel to work with a thin clone of the database](https://docs.gitlab.com/development/database/understanding_explain_plans/#database-lab)
...
1. Guidance on N+1 Queries
   1. [Query Recorder](https://docs.gitlab.com/development/database/query_recorder/)
   1. [Performance guidelines](https://docs.gitlab.com/development/performance/)
   1. [Merge request performance guidelines - Query counts](https://docs.gitlab.com/development/merge_request_concepts/performance/#query-counts)
   1. [Merge request performance guidelines - Cached queries](https://docs.gitlab.com/development/merge_request_concepts/performance/#cached-queries)
1. [Use CTEs wisely](https://docs.gitlab.com/development/merge_request_concepts/performance/#use-ctes-wisely)
1. [Use read replicas when possible](https://docs.gitlab.com/development/merge_request_concepts/performance/#use-read-replicas-when-possible)
...
1. [Postgres.ai](https://docs.gitlab.com/development/database/database_lab/) for testing with production like data.
