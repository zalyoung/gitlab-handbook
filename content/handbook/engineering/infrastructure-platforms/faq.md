...
A: [See our summary of our backup strategy](/handbook/engineering/infrastructure/production#backups)
...
A: Yes, with sufficient evidence that it's necessary, customers can request to be allowlisted. To request to be added to the allowlist, see our section on [how we handle incoming requests](/handbook/engineering/infrastructure/production#incoming-requests-of-the-infrastructure-team) in the handbook.
