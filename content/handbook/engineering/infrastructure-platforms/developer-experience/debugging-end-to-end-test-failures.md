...
You will [need access to the https://ops.gitlab.net/gitlab-com/chatops](https://docs.gitlab.com/ee/development/chatops_on_gitlabcom/#requesting-access) project to run `/chatops` commands.
...
or by calling the [`/api/v4/version` API](https://docs.gitlab.com/ee/api/version/#version-api) where it is displayed as a value of the `revision` attribute.
...
| [Screenshots and HTML captures](https://docs.gitlab.com/ee/ci/jobs/job_artifacts/#browsing-artifacts)                                                                                                                                                                                 | Available for download in the job's artifact for up to 1 week after the job run                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [QA Logs](https://docs.gitlab.com/ee/ci/jobs/job_artifacts/#browsing-artifacts)                                                                                                                                                                                                       | Included in the job's artifacts; valuable for determining the steps taken by the tests before failing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
- To determine if the test is [flaky](https://docs.gitlab.com/ee/development/testing_guide/flaky_tests/#whats-a-flaky-test), check the logs or run the test a few times. If it passes at least once but fails otherwise, it's flaky.
...
You can find some [general tips for troubleshooting problems with GitLab end-to-end tests in the development documentation](https://docs.gitlab.com/ee/development/testing_guide/end_to_end/troubleshooting/).
