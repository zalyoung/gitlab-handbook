...
The majority of our [project management process is described at the Platforms level](https://handbook.gitlab.com/handbook/engineering/infrastructure/platforms/project-management/) and is shared between all Infrastructure Platform teams. Please read this first.

The following is in addition to the process described on the Platforms page.
