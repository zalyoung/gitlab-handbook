...
1. We have a [template file](./_template.md) that you can use to create a new blueprint
1. Create a folder under this directory with the name of the blueprint and copy the template there, as `_index.md`
