...
* Automation for repository, packages, container registry within a project: a [project deploy token](https://docs.gitlab.com/user/project/deploy_tokens/) is sufficient.
* Automation via API within a project: a [project access token](https://docs.gitlab.com/user/project/settings/project_access_tokens/) is sufficient.
* Automation via API within a group: a [group access token](https://docs.gitlab.com/user/group/settings/group_access_tokens/) is sufficient.
...
By default, and when possible, create a new [project access token](https://docs.gitlab.com//user/project/settings/project_access_tokens/) for any API automation, and follow these guidelines:
...
Create a new [project deploy token](https://docs.gitlab.com/user/project/deploy_tokens/) for repository, packages, or container registry automation.
...
* [Danger bot](https://docs.gitlab.com/development/dangerbot/) for merge request hygiene. We use the [Danger bot](https://gitlab.com/group_9970_bot1) group access token.
...
* [Repository mirroring](https://docs.gitlab.com/user/project/repository/mirror/). Requires a service account.
