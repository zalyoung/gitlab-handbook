...
The GitLab vs. GitHub decision kit has been updated to include [GitLab SAST vs. GitHub Code Scanning](https://web.archive.org/web/20240331181506/https://about.gitlab.com/competition/github/) and [GitLab vs. GitHub Container Registry](https://web.archive.org/web/20240331181506/https://about.gitlab.com/competition/github/) comparison tables. Also, the CircleCI Decision Kit now includes CircleCI product gaps identified by their user community. [See all Competitive Content -->](https://about.gitlab.com/why-gitlab/)
...
---
In an effort to increase customer satisfaction and speed time to adoption, the **Professional Services Education team recently redesigned the [GitLab System Administration course](https://university.gitlab.com/pages/system-admin-training/)**. Here are the main changes:
...
1. **New "Advanced" Option:** Add on the [new advanced administration course](https://university.gitlab.com/pages/system-admin-training/) dedicated to monitoring and de-bugging, for customers with Tier 2 admin team members.
