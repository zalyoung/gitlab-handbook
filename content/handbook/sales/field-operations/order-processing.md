...
- If a renewal is achieved *more than 15 days after the Renewal Date, but less than 180 days after the Renewal Date*:
  ...
  - If the close/Lost renewal opportunity has a close date that is in the current or future month, Deal Desk can move the stage backwards to allow the renewal to remain open for processing. If the close/lost renewal opportunity has a close date in ANY previous month, the original Closed Lost opportunity will remain as is. A second Closed Lost opportunity will be created and closed with the inverse values of the original, to effectively cancel the original Closed Lost opportunity. This new Closed Lost opportunity will have the same close date as the new Closed Won renewal opportunity. See: [Opportunity Requirements for Return Customers](/handbook/sales/field-operations/gtm-resources/#opportunity-requirements-for-return-customers)
