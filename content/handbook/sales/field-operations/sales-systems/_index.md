...
11. The Architect (or assigned delegate) will assign the story a Change Management level, based on the scope of the change as defined [here](https://internal.gitlab.com/handbook/security/corporate/it/it-change-management/#change-request-types).
