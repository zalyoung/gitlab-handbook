...
- Create a New PS child Opportunity off of the standard parent opportunity using the `Create Services Opportunity` button - [PS Opportunity creation video demo here](../../../sales/field-operations/gtm-resources/_index.md#steps-for-creating-a-professional-services-opportunity-in-sfdc)
- Create a new subscription quote under the Professional Services opportunity by following the steps above under "new Subscription Quote." - [Creating SFDC Quote video demo here](https://gitlab.highspot.com/items/6865d291d8dc1faf2173afac)
  - **If the SOW contains purely Professional Services and is Fixed Fee**, select the `GitLab Service Package` SKU. Update the price to reflect the total price on the SOW. **DISREGARD DISCOUNT APPROVALS**.
  - **If the SOW contains purely Professional Services and is T&M**, select the `Hourly Consulting` SKU. Update the quantity of hours and discount % to reflect the effective price and match the SOW.
  ...
  - **If the SOW contains a mixture of Professional Services and Education Services**, two separate quotes should be created under the same opportunity.
    - Create one quote using the `Hourly Consulting` SKU if the Professional Services portion is T&M and use the `GitLab Service Package` if the Professional Services portion is Fixed Fee.
  ...
  - To determine which portion of the SOW is for Professional Services vs. Education Services, note the following: Education and Services are split out on the SOW in separate sections. The Education portion would display standard SKU names such as "CI/CD Training" and "Sys Admin Training" and will contain a total cost for the full Education portion. The Services portion would be custom, but would often denote either "Time and Materials" or "Fixed Fee" with the hours breakdown and/or total cost on the estimated fees table at the bottom of the SOW.
...
- To gain support from the Professional Services team with a Custom SOW, a scoping issue should have automatically already been generated if you used the `Create Services Opportunity` button to create the PS Opportunity. This will allow you to collaborate with a Professional Services [Engagement Manager](/handbook/customer-success/professional-services-engineering/engagement-mgmt/).
