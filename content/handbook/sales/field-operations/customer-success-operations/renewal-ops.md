...
To reach out to Renewal Operations within Salesforce, follow the process to request internal support outlined [here](https://handbook.gitlab.com/handbook/sales/field-operations/requesting-internal-support/)
...
For questions on Quoting, Approvals, Opportunity Booking or Opportunity data quality refer to the [Sales Order Processing Handbook Page](/handbook/sales/field-operations/order-processing/) or reach out to [Deal Desk via an Internal Support Request](https://handbook.gitlab.com/handbook/sales/field-operations/requesting-internal-support/)

### Compensation

For Compensation related questions please reach out to Sales Comp via the [internal support request](https://handbook.gitlab.com/handbook/sales/field-operations/requesting-internal-support/). Renewal Operations does not approve Churn exception requests, to request a Churn exception [please follow the process outlined here.](/handbook/customer-success/renewals-managers/how/#churn-exceptions).
