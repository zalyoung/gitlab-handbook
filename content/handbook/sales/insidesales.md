...
4. If you are new to GitLab, complete your [onboarding issue](/handbook/people-group/general-onboarding/#completing-onboarding-issue). If you are an internal transfer, complete your [organization change checklist](/handbook/people-group/promotions-transfers/#organization-change-checklist) and [access change request issue](content/handbook/security/corporate/end-user-services/access-requests/). These will need to be completed and closed out before regions or territories can be assigned.
