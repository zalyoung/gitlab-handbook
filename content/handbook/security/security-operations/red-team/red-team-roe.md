...
If a vulnerability is exposed that meets the following criteria, we will document the issue and follow [the process to engage SIRT](/handbook/security/security-operations/sirt/sec-incident-response/#engaging-sirt) immediately:
...
1. If a security incident is required, [engage SIRT](/handbook/security/security-operations/sirt/sec-incident-response/#engaging-sirt)
