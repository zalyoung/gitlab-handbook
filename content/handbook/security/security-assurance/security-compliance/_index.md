...
1. Identifying and mitigating information security risk through [continuous control monitoring](/handbook/handbook/security/security-assurance/security-compliance/sec-controls/) and [risk-based control testing] ([risk-based-control-testing](/handbook/handbook/security/security-assurance/security-compliance/risk-based-control-testing/)) of assets
...
1. [Continuous Monitoring of GitLab's Security Controls](/handbook/handbook/security/security-assurance/security-compliance/sec-controls/) which are mapped to applicable regulatory requirements and security certifications/frameworks we have committed to.
...
- [GCF Security Controls](/handbook/handbook/security/security-assurance/security-compliance/sec-controls/)
- [User Access Reviews](/handbook/handbook/security/security-assurance/security-compliance/access-reviews/)
- [Observation Methodology](/handbook/handbook/security/security-assurance/observation-management-procedure/)
- [Gap Analysis Program](/handbook/handbook/security/security-assurance/security-compliance/gap-analysis-program/)
