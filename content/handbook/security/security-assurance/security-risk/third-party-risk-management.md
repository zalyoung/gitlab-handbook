...
| *Can this be expedited?*  | Our team can prioritize reviews, within reason, if a requisition is critical and time-sensitive. The best way to expedite a review is to encourage the vendor to respond to our inquiries quickly. Urgent requests should be escalated to @Security-Risk in the #Procurement channel. |
...
- **Annual High-Risk Reviews:** Vendors in-scope for compliance testing (SOC2, SOX, etc.), [GitLab Sub-Processors](LINK), and vendors otherwise processing Red data are reviewed annually to meet compliance obligations.
