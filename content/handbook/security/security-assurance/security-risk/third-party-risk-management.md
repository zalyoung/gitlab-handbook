...
Where GitLab controls, owns, or is otherwise responsible for data, the diagram below depicts TPRM procedures based on the [Data Classification](/handbook/handbook/security/data-classification-standard/) of data shared with the third party.
...
- [Observation Management Procedure](/handbook/handbook/security/security-assurance/observation-management-procedure/)
