...
**Note:** In adjacent to the BIA, questions may be asked to satisfy global privacy regulation requirements pertaining to a system's [Personal Data](/handbook/security/data-classification-standard/#data-classification-definitions) processing.
