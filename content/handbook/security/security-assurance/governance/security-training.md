...
- Special topics covered:
  - [Suspected phishing](/handbook/handbook/security/security-assurance/governance/phishing/#how-to-identify-a-basic-phishing-attack)
  ...
  - [Data Classification](/handbook/handbook/security/data-classification-standard/)
...
As a [DevOps](https://about.gitlab.com/topics/devops/) company, it makes sense that we need to focus on producing secure code, and therefore training of our developers is a high priority item. There is an entire [handbook page dedicated to Secure Coding training](/handbook/handbook/security/secure-coding-training/) with numerous references to both required and recommended training.
...
- Review the [GitLab Data Classification Standard](/handbook/handbook/security/data-classification-standard/) so you are aware of what is considered public vs non-public data. [GREEN](/handbook/handbook/security/data-classification-standard/#green) data can be publicly shareable, any training content that is not GREEN data should not be included in publicly-accessible training material.
