...
Okta supports strong passwords through the use of password complexity rules and length, consistent with our password policy. Please follow [GitLab's Password Standards](/handbook/security/standards/password-standard/) to determine the rules.
