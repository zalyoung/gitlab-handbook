...
1. Make sure you are using an approved [Linux distribution](https://internal.gitlab.com/handbook/security/corporate/it/it-self-service/operating-systems/#linux).
