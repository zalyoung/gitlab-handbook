...
GitLab approves and supports the use of macOS as the preferred OS for employee laptops. We also approve Linux for employee laptops, however team members must be self supporting. For security concerns and support efficiency reasons, Windows is not supported as a hardware laptop OS for team members unless it is for [specific product development and testing use cases](#windows).
...
Apple hardware is the common choice among GitLab team members. Team members may also select a Dell Linux laptop if they are familiar with Linux and capable of self support. Please do not select Linux if you have never used macOS or Apple products before.
...
*Laptop configurations are based on regional inventory*

* MacBook Pro 14"
* At least M3 Processor
* 16-36GB Memory
* 512GB-1TB Storage
...
* At least M3 Max Processor
* 36-64GB Memory
* 1TB Storage

> We pre-order laptops through our global vendors so they are ready to ship to team members in most regions. This ensures that team members have a consistent purchase experience and delivery timeline. 
>
> As a result, configuration may be limited based on regional vendor inventory. For example, we may only have 2024 models in Space Gray in some regions and 2025 models in Silver in another. 
...
We have standardized on the [Dell Precision 5690](https://www.dell.com/en-us/shop/dell-computer-laptops/new-precision-5690-workstation/spd/precision-16-5690-laptop/s004p5690usvp) Mobile Workstation laptops. Due to supply constraints, specific models available from these lines may vary.

These laptops generally come pre-loaded with Ubuntu Linux in order to save money on unused Windows licenses. Dell does not currently sell laptops pre-installed with Linux in Australia and New Zealand; staff will need to install Linux themselves.
