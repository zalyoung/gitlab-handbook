...
Laptops must be wiped with [Jamf](/handbook/security/corporate/systems/jamf) for macOS, and [DriveStrike](https://internal.gitlab.com/handbook/security/corporate/it/it-self-service/it-guides/drivestrike/) for Linux. Using these tools ensures a clean disk wipe is performed and GitLab can retain evidence of the disk wipe.
