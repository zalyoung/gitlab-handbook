...
- If the meeting hasn't started yet, the Meeting ID won't appear in the Zoom client, but it's in the URL, and you can still connect to the audio with the phone
...
- If you don't give it when you first connect, your audio and video might appear in separate boxes in the Zoom window, as if you're in the meeting twice
  - This may be confusing to others, as your video won't be highlighted when you talk
...
- After delivering the initial value prop: You should most certainly check in after delivering GitLab's value proposition or key message.
  - It's generally best to use people's names e.g. 'John, Ryan, please let me know if there is anything you would like me to clarify in more detail?'
...
That's because, without an audience in front of us, we tend to speed up and truncate our pauses even more. So be extra mindful of this and of your audience.\
...
- An up to date list of Mac compatible external webcams can be found [here](https://www.imore.com/best-webcams-mac)
