...
1. Click on the blue **Launch Zoom Workplace** button in your Chrome tab. You sould now see your profile picture in the top-right corner of the Zoom app window
...
1. Click on the **Zoom** icon on the right-side of the screen
    1. If the icon is not available, click on the `+` button on the righ-side of the screen and install the `Zoom` extension from the `Google Workspace Marketplace`
