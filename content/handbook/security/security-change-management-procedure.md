...
- Assign the appropriate team member(s) to the request in accordance with the [roles and responsibilities](/handbook/handbook/security/security-change-management-procedure/#roles--responsibilities) and [approval matrix](/handbook/handbook/security/security-change-management-procedure/#approval-matrix) sections
