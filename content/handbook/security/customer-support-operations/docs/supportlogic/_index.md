...
<br>Pricing Model: **Usage-based (Credits)**</br>
...
| 40+ Signal Extraction | Pulls out over 40 different customer sentiment signals (e.g urgency, frustration, product mentions and etc) from our support data using AI and NLP. |

Modules such as `Assign` (Intelligent Case Assignment), `Elevate` (Quality Monitoring), `Assist` (Support Productivity) and `Expand` (Account Management) are seat based license and not included in our current subscription. See [SupportLogic's pricing page](https://www.supportlogic.com/pricing/) for more details.
