...
* Does this feature handle [`RED` and/or `ORANGE`](https://handbook.gitlab.com/handbook/security/standards/data-classification-standard/#red) data? (Y/N)
...
* 4: Direct access/modification to [`RED` and/or `ORANGE`](https://handbook.gitlab.com/handbook/security/standards/data-classification-standard/#red) data. See 
