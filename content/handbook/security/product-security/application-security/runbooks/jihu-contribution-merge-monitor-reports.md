...
The Merge Monitor runs via scheduled pipeline. It de-duplicates any findings by checking for open Merge Monitor Report issues for [related merge requests](https://docs.gitlab.com/user/project/issues/crosslinking_issues/#from-merge-requests) and filtering out any findings that are already known.
