...
1. Service accounts with access to RED data MUST follow the [Access Request](/handbook/security/corporate/it/end-user-services/onboarding-access-requests/access-requests/#shared-account-access-request)
   process.
...
[Okta](/handbook/security/corporate/it/okta/) is our corporate identity and authentication provider. Configuration of
