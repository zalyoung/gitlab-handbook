...
- Replacing the custom categorization of projects using YAML files in the [inventory](https://gitlab.com/gitlab-com/gl-security/product-security/inventory/) and replacing it with [Compliance Frameworks](https://docs.gitlab.com/ee/user/group/compliance_frameworks/) labels when we can [assign multiple labels](https://gitlab.com/groups/gitlab-org/-/epics/13294)
- Use the [Dependencies API](https://docs.gitlab.com/ee/api/dependencies/) instead of the inventory in [gem-checker](https://gitlab.com/gitlab-com/gl-security/product-security/appsec/tooling/gem-checker) when the API becomes stable
