...
- **Family Relationship:** Use this field to let CES know if there's a family relationship that will require a [Family Member Acknowledgement form](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#how-to-send-a-family-member-relationship-acknowledgment).
- **Signatory Name & Signatory Title:** See [this chart](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#entity-contract-signatories) for a list of signatories per country.
