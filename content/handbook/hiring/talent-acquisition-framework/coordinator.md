...
[See Candidate Experience Specialist Contract Processes section of the handbook](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes)
...
Recruiters should make themselves familiar with the basic knowledge of the contract processes that can be found on the [CES Contract Processes](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes) page and the [Contracts, Probation Periods & PIAA](/handbook/people-group/contracts-probation-periods/) page, as well as the [Employment Contracts](https://internal.gitlab.com/handbook/people-group/people-operations/people-connect/employment_contracts/) page in the internal handbook.
...
1. [Generate the contract within Greenhouse](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes) using a template based on the details found in the offer package.
...
1. [Stage the contract in DocuSign from within Greenhouse](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes), which emails the contract to the signing parties, with the recruiter, talent acquisition manager, and the hiring manager cc'd. It will be sent to the designated signatory as previously determined in Offer Details.
...
1. Should the start date change after the welcome email is sent please see the required steps [here](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#how-to-update-a-start-date-after-the-contract-is-signed).
...
### How to Update a Start Date After a French or Spain contract has been signed
   ...
   Please follow the normal start date change [process](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#how-to-update-a-start-date-after-the-contract-is-signed), thereafter, please follow the following steps:
...
1. Please use the signatories listed against the German Entity as per this [table](/handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#entity-contract-signatories)
