...
[See Candidate Experience Specialist Contract Processes section of the handbook](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes)
...
1. [Generate the contract within Greenhouse](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes) using a template based on the details found in the offer package.
...
1. [Stage the contract in DocuSign from within Greenhouse](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#ces-contract-processes), which emails the contract to the signing parties, with the recruiter, talent acquisition manager, and the hiring manager cc'd. It will be sent to the designated signatory as previously determined in Offer Details.
...
1. Should the start date change after the welcome email is sent please see the required steps [here](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#how-to-update-a-start-date-after-the-contract-is-signed).
...
### How to Update a Start Date After a French or Spain contract has been signed
   ...
   Please follow the normal start date change [process](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#how-to-update-a-start-date-after-the-contract-is-signed), thereafter, please follow the following steps:
...
1. Please use the signatories listed against the German Entity as per this [table](https://handbook.gitlab.com/handbook/hiring/talent-acquisition-framework/coordinator/#entity-contract-signatories)
