...
1. If the contractor is employed via a third-party agency, please reach out to the agency to confirm the end date of their current contract
...
2. Ensure the role you want to convert the contractor into has a [job family](https://handbook.gitlab.com/job-families/) 
...
If all of the steps above have been completed and we’re able to move forward, please reach out to a [Talent Acquisition Leader](https://handbook.gitlab.com/handbook/hiring/recruiting-alignment/) to get this process started. From there, one of our Recruiters will work with you to: 
...
- If more than one current contractor is interviewing for a full-time role, the hiring manager will be making a decision based on overall skills and experience for the role. If the budget allows, the contractor not selected for the full-time role can continue in their role under their current contract. 
- If a current contractor is interviewing for a role that is also open externally, the hiring manager will ultimately hire the strongest candidate for the role. If the budget allows, the current contractor can continue in their current contract role if not selected for the full-time opportunity. 
- There may be situations where a contractor from one team is interviewing for a full-time role on another GitLab team. 
