...
- [Create a merge request from an issue](https://docs.gitlab.com/ee/user/project/repository/web_editor/#create-a-new-branch-from-an-issue)
- [Measure DevOps success via the DORA metrics](https://docs.gitlab.com/ee/api/dora/metrics/)
- [Create Incidents as an Issue Type](https://docs.gitlab.com/ee/operations/incident_management/manage_incidents/#from-the-issues-list)
- [Connect your clusters via the CI/CD Tunnel](https://docs.gitlab.com/ee/user/clusters/agent/ci_cd_workflow/)
- [Relate issues and Feature Flags](https://docs.gitlab.com/ee/operations/feature_flags/#feature-flag-related-issues)
- [Run multiple pipelines and project dependencies with multi-project pipelines](https://docs.gitlab.com/ee/ci/pipelines/downstream_pipelines/#multi-project-pipelines)
