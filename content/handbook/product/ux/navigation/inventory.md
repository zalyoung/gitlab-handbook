...
1. Generate the latest navigation information from the `gitlab-org/gitlab` repo. See [Development Rake tasks](https://docs.gitlab.com/ee/development/rake_tasks/#output-current-navigation-structure-to-yaml) for instructions.
