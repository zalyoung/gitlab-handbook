...
* Launching an [Experiment](https://docs.gitlab.com/ee/policy/development_stages_support/#experiment) or [Beta](https://docs.gitlab.com/ee/policy/development_stages_support/) feature
...
1. When you have approval and are ready to start implementation, then follow the [GitLab Docs on adding items to the navigation](https://docs.gitlab.com/ee/development/navigation_sidebar/#adding-page-specific-vue-content).
