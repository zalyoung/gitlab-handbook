...
- **How do I eliminate question order bias in a study?** When trying to assess Prototype A vs Prototype B and you can use a [balanced comparison](https://help.usertesting.com/hc/en-us/articles/11880445536541-Balanced-comparison) to alternate the order that participants see the variants to reduce the risk of ordering bias on results.
