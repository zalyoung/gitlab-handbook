...
1. [Prepare your prototype or demo environment](/handbook/product/ux/category-maturity/category-maturity-scorecards/#step-2-prepare-your-testing-environment).
   - Consider which mode to test in: Use light mode by default for usability testing to help maintain testing efficiency while ensuring consistency across studies. Only test in dark mode when evaluating factors that might influence user behavior and test outcomes, such as: how visual hierarchy affects reading patterns and task completion; the relationship between specific tasks and mode effectiveness; user preferences and health considerations; environmental contexts; session duration; and ecosystem compatibility with other applications.
