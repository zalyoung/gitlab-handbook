...
- Create a screener draft in Google Docs to easily collaborate with others before implementing in a survey platform. Instead of creating screener questions from scratch, you can leverage the [screener repository document](https://docs.google.com/document/d/1v8_a3DH9UKhakn61Z1vFXUT-IOAPC6-FwJegaquYUS4/edit?usp=sharing) to find questions commonly used across different areas of the business (e.g., Core DevSecOps, security and compliance) as well as more general demographic questions.
