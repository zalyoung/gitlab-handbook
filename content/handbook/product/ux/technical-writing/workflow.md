...
- [`docs-missing`](https://gitlab.com/groups/gitlab-org/-/labels?subscribed=&sort=relevance&search=docs-missing): Issue or MR is missing documentation. Documentation is required with the delivery of a feature for a specific milestone as part of the GitLab [definition of done](https://docs.gitlab.com/ee/development/contributing/merge_request_workflow.html#definition-of-done). Add the label, and follow up with the Development team. Does not apply to [experimental features](https://docs.gitlab.com/ee/policy/development_stages_support.html#experiment).
