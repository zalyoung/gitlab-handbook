...
- If you haven't already, [install Git](https://docs.gitlab.com/ee/topics/git/how_to_install_git/)
  and [add an SSH key to your GitLab profile](https://docs.gitlab.com/ee/user/ssh/#add-an-ssh-key-to-your-gitlab-account).
...
- Install documentation
  ...
  - [markdownlint](https://docs.gitlab.com/ee/development/documentation/testing/markdownlint/)
  - [Vale](https://docs.gitlab.com/ee/development/documentation/testing/vale/)
