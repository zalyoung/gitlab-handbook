...
Naming new features or [renaming existing features](https://docs.gitlab.com/ee/development/renaming_features/) is notoriously hard and sensitive to many opinions.
...
[Documentation on permissions](https://docs.gitlab.com/ee/user/permissions/)
...
GitLab can be a [provider of authentication](https://docs.gitlab.com/ee/integration/oauth_provider/) for external applications.
