...
- [Tasks](https://docs.gitlab.com/ee/user/tasks/) (optional): Decompose an Issue into more detailed implementation steps.
...
- [Boards](https://docs.gitlab.com/ee/user/project/issue_board/): Aid in visualizing work moving through the [product development flow](/handbook/product-development-flow/_index.md) and for milestone planning.
...
1. **Deprecated, removed, or no-longer-supported functionality:** You should close issues that won't be worked on because the functionality has been [officially deprecated or removed, or has reached End of Support](https://docs.gitlab.com/ee/update/terminology/).
...
[issue board](https://docs.gitlab.com/ee/user/project/issue_board/) for your group.
