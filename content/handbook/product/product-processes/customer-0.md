...
- Customer 0 must surface unmet user needs and propose feature requests based on hands-on use and experience. This should include details of the use case, need, and expected functionality.
- If Customer 0 uses/creates a work around due to shortcomings of the product, there is an open issue that they regularly monitor and will plan to migrate to internal functionality when resolved.
...
- In line with our Product Principles, Customer 0 recognises that we are not a replacement of actual customers, nor can we fully represent the diversity of customer experiences.
...
The main difference is what moment of the product development flow a feature is in: While the Customer 0 model is relevant for the ideation, development and launch of new features, dogfooding becomes important once these features are part of our product.
