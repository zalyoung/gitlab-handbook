...
If you received a macOS system from GitLab and were  able to follow the [instructions above](#laptop-setup-macbook), it is highly likely that you are enrolled in Jamf automatically and no further action is required. If you are unsure, check if your macOS Dock contains Google Chrome, 1Password, Slack and Zoom, which would be installed via Jamf. 

If you do not see those applications, please check [this guide](https://internal.gitlab.com/handbook/it/endpoint-tools/jamf/#enrolling-in-jamf) for assistance with enrolling in Jamf.
