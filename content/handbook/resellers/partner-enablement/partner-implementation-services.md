...
- [Other Installation Methods](https://docs.gitlab.com/install/install_methods/)
...
- [Unsupported Designs](https://docs.gitlab.com/administration/reference_architectures/#deviating-from-the-suggested-reference-architectures)
  - Also review these unsupported configurations to make sure you are in compliance with our support requirements.
- [Next Implementation Steps After Installation](https://docs.gitlab.com/install/next_steps/)
...
- [GitLab Runner Monitoring](https://docs.gitlab.com/runner/monitoring/) and [GitLab Runner Fleet Dashboards](https://docs.gitlab.com/ci/runners/runner_fleet_dashboard/)
...
2. Optionally get access to free Premium or Ultimate features through our [Registration Features Program](https://docs.gitlab.com/administration/settings/usage_statistics/#registration-features-program). You can find the list of those features [here](https://docs.gitlab.com/administration/settings/usage_statistics/#available-features).
