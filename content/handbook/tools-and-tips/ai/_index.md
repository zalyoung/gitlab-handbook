...
This handbook section contains useful tips for working with AI at GitLab. GitLab team members should be familiar with the [General Purpose AI Tool Usage Requirements](https://internal.gitlab.com/handbook/legal-and-corporate-affairs/ai-tool-usage-requirements/).

## Usage requirements and FAQs

### Approved AI Tools

If your requested AI tool is not included in this list, seek approval via the processes described in this section. RPlease refer to the [General Purpose AI Tool Usage Requirements](https://internal.gitlab.com/handbook/legal-and-corporate-affairs/ai-tool-usage-requirements/) for guidance on the use of general purpose AI tools in your work at GitLab.
...
Some AI features in existing Tech Stack systems may also be approved for use. To learn more, see the [General Purpose AI Tool Usage Requirements](https://internal.gitlab.com/handbook/legal-and-corporate-affairs/ai-tool-usage-requirements/).
