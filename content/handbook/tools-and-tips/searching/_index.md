...
You can search repositories in GitLab for changes using [Git file History](https://docs.gitlab.com/ee/user/project/repository/files/git_history/) and [Git blames](https://docs.gitlab.com/ee/user/project/repository/files/git_blame/).
