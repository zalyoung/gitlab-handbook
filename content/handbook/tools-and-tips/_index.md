...
1. **To-do list:** all team members will see a [to-do list](https://docs.gitlab.com/ee/user/todos/) within their GitLab account. This will track different action items. Items can be marked as done as they are completed.
1. **Email:** team members can choose which, if any, notifications show up in their Gmail accounts by [using filters](#filters).
1. **Slack notifications:** team members can choose to enable [Slack notifications](https://docs.gitlab.com/ee/user/project/integrations/gitlab_slack_application/). Please note that GitLab slack expires after 90 days, so this is not a tool for longer-term activity management.
...
Mermaid is a tool that allows us to create flowcharts, graphs, diagrams, Gantt charts, etc. within GitLab! Check out the [examples in the GitLab docs](https://docs.gitlab.com/ee/user/markdown/#mermaid) on how to use Mermaid.
...
If you are working on multiple GitLab instances and want to have a visual differentiation, you can change the default [Navigation theme](https://docs.gitlab.com/ee/user/profile/preferences/#navigation-theme) to a different color.
